...
class ExportToHE8:
    ...
    def run(self):
        ...
        if not database_QKan:
            fehlermeldung(u"Fehler in exporthe8", u"database_QKan konnte nicht aus den Layern ermittelt werden. Abbruch!")
            logger.error("exporthe8: database_QKan konnte nicht aus den Layern ermittelt werden. Abbruch!")
            return False
