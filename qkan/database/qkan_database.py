...
__dbVersion__ = "3.2.12"  # Version der QKan-Datenbank
__qgsVersion__ = "3.2.12"  # Version des Projektes und der Projektdatei. Kann höher als die der QKan-Datenbank sein
