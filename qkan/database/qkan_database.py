...
__qgsVersion__ = "3.2.16"  # Version des Projektes und der Projektdatei. Kann höher als die der QKan-Datenbank sein
...
def createdbtables(
    ...
    sql = """
        CREATE TABLE IF NOT EXISTS flaechen_he8 (
            ...
            LastModified TEXT DEFAULT (strftime('%d.%m.%Y %H:%M:%S','now','localtime')), 
            Kommentar TEXT)"""
