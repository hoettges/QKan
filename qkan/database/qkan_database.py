...
__dbVersion__ = "3.1.6"  # Version der QKan-Datenbank
__qgsVersion__ = "3.1.8"  # Version des Projektes und der Projektdatei. Kann höher als die der QKan-Datenbank sein
