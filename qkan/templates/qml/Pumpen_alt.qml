...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" version="3.20.1-Odense" simplifyMaxScale="1" minScale="0" readOnly="0" simplifyDrawingHints="1" labelsEnabled="0">
    ...
    <symbols>
      <symbol type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="0">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="@0@0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="pumpentypen20161018090730556" type="QString" name="Layer"/>
            <Option value="0" type="QString" name="OrderByValue"/>
            <Option value="1" type="QString" name="UseCompleter"/>
  ...
  <aliases>
    ...
    <alias index="1" field="pnam" name=""/>
    <alias index="2" field="schoben" name=""/>
    <alias index="3" field="schunten" name=""/>
    <alias index="4" field="pumpentyp" name=""/>
    <alias index="5" field="volanf" name=""/>
    <alias index="6" field="volges" name=""/>
    <alias index="7" field="sohle" name=""/>
    <alias index="8" field="steuersch" name=""/>
    <alias index="9" field="einschalthoehe" name=""/>
    <alias index="10" field="ausschalthoehe" name=""/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="pnam" constraints="0"/>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="pumpentyp" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="volanf" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="volges" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="sohle" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="steuersch" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="einschalthoehe" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="ausschalthoehe" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="pnam"/>
    <constraint exp="" desc="" field="schoben"/>
    <constraint exp="" desc="" field="schunten"/>
    <constraint exp="" desc="" field="pumpentyp"/>
    <constraint exp="" desc="" field="volanf"/>
    <constraint exp="" desc="" field="volges"/>
    <constraint exp="" desc="" field="sohle"/>
    <constraint exp="" desc="" field="steuersch"/>
    <constraint exp="" desc="" field="einschalthoehe"/>
    <constraint exp="" desc="" field="ausschalthoehe"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" hidden="0" name="pnam" width="-1"/>
      <column type="field" hidden="0" name="schoben" width="-1"/>
      <column type="field" hidden="0" name="schunten" width="-1"/>
      <column type="field" hidden="0" name="pumpentyp" width="-1"/>
      <column type="field" hidden="0" name="volanf" width="-1"/>
      <column type="field" hidden="0" name="volges" width="-1"/>
      <column type="field" hidden="0" name="sohle" width="-1"/>
      <column type="field" hidden="0" name="steuersch" width="-1"/>
      <column type="field" hidden="0" name="einschalthoehe" width="-1"/>
      <column type="field" hidden="0" name="ausschalthoehe" width="-1"/>
