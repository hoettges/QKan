...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyAlgorithm="0" labelsEnabled="0" version="3.22.4-Białowieża" minScale="0" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyMaxScale="1" simplifyLocal="1" styleCategories="AllStyleCategories">
  <flags>
  ...
  <aliases>
    ...
    <alias field="zufluss" name="Zufluss (m³/s)" index="5"/>
    <alias field="ew" name="EW" index="6"/>
    <alias field="einzugsgebiet" name="Einzugsgebiet" index="7"/>
  ...
  <constraints>
    ...
    <constraint field="zufluss" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="ew" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="einzugsgebiet" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
