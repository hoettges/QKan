...
<qgis styleCategories="Symbology" version="3.22.16-Białowieża">
  <renderer-v2 forceraster="0" enableorderby="0" type="categorizedSymbol" symbollevels="0" attr="entwart" referencescale="-1">
    <categories>
      <category value="Mischwasser" symbol="0" render="true" label="Mischwasser"/>
      <category value="Regenwasser" symbol="1" render="true" label="Regenwasser"/>
      <category value="Schmutzwasser" symbol="2" render="true" label="Schmutzwasser"/>
      <category value="MW nicht angeschlossen" symbol="3" render="true" label="MW nicht angeschlossen"/>
      <category value="RW nicht angeschlossen" symbol="4" render="true" label="RW nicht angeschlossen"/>
    </categories>
    <symbols>
      ...
      <symbol clip_to_extent="1" name="4" force_rhr="0" type="line" alpha="1">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@4@3" force_rhr="0" type="marker" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
