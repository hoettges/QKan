...
<qgis styleCategories="AllStyleCategories" maxScale="0" minScale="3000" labelsEnabled="1" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" version="3.28.13-Firenze" simplifyDrawingHints="0" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1">
<flags>
      ...
      <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" type="RuleRenderer" symbollevels="0">
        <rules key="{768237f4-5e8a-4ffd-91b9-7f7ae414c2f6}">
          <rule label="&lt; 1:5.000" scalemindenom="5000" key="{555c4b0c-0ac1-4f0d-830e-3b5a42fc7b29}" symbol="0"/>
          <rule label="1:500 bis 1:5.000" scalemindenom="500" key="{ffa1abd3-02c8-4574-9fb2-5c87b0e49566}" symbol="1" scalemaxdenom="5000"/>
          <rule label="> 1:500" key="{7b62dc7d-874e-4d73-bd4f-7e4fb3bb6b32}" symbol="2" scalemaxdenom="500"/>
        </rules>
        <symbols>
          <symbol alpha="1" is_animated="0" name="0" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
          ...
          <symbol alpha="1" is_animated="0" name="1" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
          ...
          <symbol alpha="0.8" is_animated="0" name="2" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
                ...
                <Option value="solid" name="outline_style" type="QString"/>
                <Option value="0.05" name="outline_width" type="QString"/>
                <Option value="3x:0,0,0,0,0,0" name="outline_width_map_unit_scale" type="QString"/>
      ...
      <labeling type="rule-based">
        <rules key="{1334cb10-eb86-439f-a691-ceec578293fd}">
          <rule description="Beschriftung Schacht" key="{de67c57a-b344-48aa-a738-16f9e52ed019}" scalemaxdenom="1500">
            <settings calloutType="simple">
              <text-style fontLetterSpacing="0" fontItalic="0" capitalization="0" useSubstitutions="0" fontSize="10" fontWordSpacing="0" blendMode="0" allowHtml="0" forcedItalic="0" legendString="Aa" namedStyle="Regular" multilineHeightUnit="Percentage" fontSizeUnit="Point" textOpacity="1" fontUnderline="0" textOrientation="horizontal" fontWeight="50" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="MS Shell Dlg 2" forcedBold="0" fontStrikeout="0" fieldName="&quot;schnam&quot; || '\n' || 'D ' || &quot;deckelhoehe&quot;||'\n' || 'S ' || &quot;sohlhoehe&quot;" multilineHeight="1" isExpression="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="50,50,50,255">
                <families/>
                <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferDraw="1" bufferSize="1" bufferColor="250,250,250,255" bufferBlendMode="0" bufferJoinStyle="128"/>
              ...
              <text-format reverseDirectionSymbol="0" addDirectionSymbol="0" rightDirectionSymbol=">" multilineAlign="3" formatNumbers="0" decimals="3" plussign="0" wrapChar="" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" autoWrapLength="0"/>
              <placement priority="5" placement="6" offsetUnits="MM" overlapHandling="PreventOverlap" layerType="PointGeometry" centroidInside="0" polygonPlacementFlags="2" preserveRotation="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="1" overrunDistanceUnit="MM" lineAnchorTextPoint="CenterOfText" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" lineAnchorPercent="0.5" repeatDistanceUnits="MM" rotationAngle="0" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="0" overrunDistance="0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" quadOffset="4" dist="5" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" rotationUnit="AngleDegrees" lineAnchorClipping="0" allowDegraded="0" fitInPolygonOnly="0" distUnits="MM" lineAnchorType="0" centroidWhole="0"/>
              ...
              <callout type="simple">
                <Option type="Map">
                  ...
                  <Option value="3" name="minLength" type="double"/>
      ...
      <DiagramLayerSettings zIndex="0" placement="0" priority="0" dist="0" obstacle="0" showAll="1" linePlacementFlags="2">
        <properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;knotentypen&quot;" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="false" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;schachttypen&quot;" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="false" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
      ...
      <aliases>
        ...
        <alias field="schnam" index="1" name="Schachtname"/>
        <alias field="sohlhoehe" index="2" name="Sohlhöhe"/>
        <alias field="deckelhoehe" index="3" name="Deckelhöhe"/>
        <alias field="durchm" index="4" name="Durchmesser"/>
        <alias field="druckdicht" index="5" name="Druckdicht"/>
        <alias field="ueberstauflaeche" index="6" name="Überstaufläche"/>
        <alias field="entwart" index="7" name="Entwässerungssystem"/>
        <alias field="strasse" index="8" name="Straße"/>
        <alias field="baujahr" index="9" name=""/>
        <alias field="eigentum" index="10" name="Eigentümer"/>
        <alias field="teilgebiet" index="11" name="Teilgebiet"/>
        <alias field="knotentyp" index="12" name="Knotentyp"/>
        <alias field="auslasstyp" index="13" name="Auslasstyp"/>
        <alias field="schachttyp" index="14" name="Schachttyp"/>
        <alias field="simstatus" index="15" name="Planungsstatus"/>
        <alias field="material" index="16" name="Material"/>
        <alias field="xsch" index="17" name=""/>
        <alias field="ysch" index="18" name=""/>
        <alias field="kommentar" index="19" name="Kommentar"/>
        <alias field="createdat" index="20" name="erstellt"/>
        <alias field="geom" index="21" name=""/>
      </aliases>
      <defaults>
        ...
        <default field="knotentyp" applyOnUpdate="0" expression=""/>
        <default field="auslasstyp" applyOnUpdate="0" expression=""/>
        <default field="schachttyp" applyOnUpdate="0" expression=""/>
      ...
      <constraints>
        ...
        <constraint field="schnam" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="sohlhoehe" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="deckelhoehe" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="durchm" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="druckdicht" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="ueberstauflaeche" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        ...
        <constraint field="knotentyp" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="auslasstyp" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="schachttyp" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        ...
        <constraint field="xsch" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="ysch" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        ...
        <constraint field="geom" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
      </constraints>
      ...
      <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
        <columns>
          ...
          <column name="sohlhoehe" hidden="0" width="-1" type="field"/>
          <column name="deckelhoehe" hidden="0" width="-1" type="field"/>
          <column name="durchm" hidden="0" width="-1" type="field"/>
          <column name="druckdicht" hidden="0" width="-1" type="field"/>
          <column name="ueberstauflaeche" hidden="0" width="-1" type="field"/>
          ...
          <column name="knotentyp" hidden="0" width="-1" type="field"/>
          <column name="auslasstyp" hidden="0" width="-1" type="field"/>
          ...
          <column name="xsch" hidden="0" width="-1" type="field"/>
          <column name="ysch" hidden="0" width="-1" type="field"/>
          <column name="kommentar" hidden="0" width="-1" type="field"/>
          <column name="createdat" hidden="0" width="-1" type="field"/>
          <column name="geom" hidden="0" width="-1" type="field"/>
