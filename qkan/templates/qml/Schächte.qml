...
<qgis hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" simplifyDrawingTol="1" version="3.22.4-Białowieża" simplifyDrawingHints="0" maxScale="0" labelsEnabled="1" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Temporal|Legend|Notes" minScale="3000" simplifyMaxScale="1" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{768237f4-5e8a-4ffd-91b9-7f7ae414c2f6}">
      <rule scalemindenom="5000" symbol="0" key="{555c4b0c-0ac1-4f0d-830e-3b5a42fc7b29}"/>
      <rule scalemindenom="500" symbol="1" key="{ffa1abd3-02c8-4574-9fb2-5c87b0e49566}" scalemaxdenom="5000"/>
      <rule symbol="2" key="{7b62dc7d-874e-4d73-bd4f-7e4fb3bb6b32}" scalemaxdenom="500"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{4a086b64-c675-4480-83a6-be99debb9b6e}">
      <rule key="{2e194fba-463a-4a2c-a27a-440e869c64d5}" scalemaxdenom="1500" description="Beschriftung Schacht">
        <settings calloutType="simple">
          <text-style fontKerning="1" textOrientation="horizontal" fontSize="10" fontItalic="0" fontWordSpacing="0" isExpression="1" fontWeight="50" fontUnderline="0" textColor="50,50,50,255" fontLetterSpacing="0" allowHtml="0" namedStyle="Regular" legendString="Aa" fontSizeMapUnitScale="3x:0,0,0,0,0,0" blendMode="0" fontSizeUnit="Point" multilineHeight="1" useSubstitutions="0" capitalization="0" fontStrikeout="0" previewBkgrdColor="255,255,255,255" textOpacity="1" fontFamily="MS Shell Dlg 2" fieldName="&quot;schnam&quot; || '\n' || 'D ' || &quot;deckelhoehe&quot;||'\n' || 'S ' || &quot;sohlhoehe&quot;">
            <families/>
            <text-buffer bufferSize="1" bufferBlendMode="0" bufferSizeUnits="MM" bufferNoFill="1" bufferColor="250,250,250,255" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferOpacity="1"/>
            ...
            <background shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeJoinStyle="64" shapeSizeY="0" shapeDraw="0" shapeRotationType="0" shapeBorderColor="128,128,128,255" shapeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeBorderWidthUnit="Point" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeX="0" shapeRadiiUnit="Point" shapeRotation="0" shapeSVGFile="" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeRadiiY="0" shapeOffsetX="0" shapeBorderWidth="0" shapeOpacity="1" shapeSizeUnit="Point" shapeOffsetY="0" shapeOffsetUnit="Point">
            ...
            <shadow shadowOpacity="0.69999999999999996" shadowColor="0,0,0,255" shadowOffsetAngle="135" shadowRadiusUnit="MM" shadowDraw="0" shadowOffsetGlobal="1" shadowRadius="1.5" shadowOffsetDist="1" shadowScale="100" shadowUnder="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowRadiusAlphaOnly="0" shadowBlendMode="6" shadowOffsetUnit="MM" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
            <dd_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
          ...
          <placement offsetType="1" placement="6" distMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" rotationUnit="AngleDegrees" overrunDistanceUnit="MM" centroidWhole="0" xOffset="0" preserveRotation="1" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" fitInPolygonOnly="0" yOffset="0" quadOffset="4" layerType="PointGeometry" maxCurvedCharAngleIn="25" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" lineAnchorClipping="0" centroidInside="0" repeatDistanceUnits="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" geometryGenerator="" geometryGeneratorEnabled="0" dist="5" priority="5" lineAnchorPercent="0.5" lineAnchorType="0" placementFlags="10"/>
          <rendering scaleMin="0" upsidedownLabels="0" scaleMax="0" labelPerPart="0" displayAll="0" scaleVisibility="0" minFeatureSize="0" drawLabels="1" obstacleFactor="1" zIndex="0" unplacedVisibility="0" fontMaxPixelSize="10000" obstacle="1" limitNumLabels="0" fontMinPixelSize="3" maxNumLabels="2000" fontLimitPixelSize="0" obstacleType="1" mergeLines="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
              <Option name="properties"/>
          ...
          <callout type="simple">
            <Option type="Map">
              ...
              <Option type="double" name="minLength" value="3"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option type="List" name="dualview/previewExpressions">
        <Option type="QString" value="&quot;schnam&quot;"/>
      </Option>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="LayerName" value="Entwässerungsarten"/>
            <Option type="QString" name="LayerProviderName" value="spatialite"/>
            <Option type="QString" name="LayerSource" value="dbname='juelich.sqlite' table=&quot;entwaesserungsarten&quot;"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="Layer" value="eigentum_a1c903df_4af8_4ecf_9da6_8892afa11450"/>
            <Option type="QString" name="LayerName" value="Eigentum"/>
            <Option type="QString" name="LayerProviderName" value="spatialite"/>
            <Option type="QString" name="LayerSource" value="dbname='juelich.sqlite' table=&quot;eigentum&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
            <Option type="bool" name="OrderByValue" value="false"/>
            <Option type="bool" name="UseCompleter" value="true"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="LayerName" value="Knotentypen"/>
            <Option type="QString" name="LayerProviderName" value="spatialite"/>
            <Option type="QString" name="LayerSource" value="dbname='juelich.sqlite' table=&quot;knotentypen&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
            <Option type="bool" name="OrderByValue" value="false"/>
            <Option type="bool" name="UseCompleter" value="true"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="LayerName" value="Schachttypen"/>
            <Option type="QString" name="LayerProviderName" value="spatialite"/>
            <Option type="QString" name="LayerSource" value="dbname='juelich.sqlite' table=&quot;schachttypen&quot;"/>
            <Option type="int" name="NofColumns" value="1"/>
            <Option type="bool" name="OrderByValue" value="false"/>
            <Option type="bool" name="UseCompleter" value="true"/>
  ...
  <aliases>
    ...
    <alias index="1" field="schnam" name="Schachtname"/>
    <alias index="2" field="sohlhoehe" name="Sohlhöhe"/>
    <alias index="3" field="deckelhoehe" name="Deckelhöhe"/>
    <alias index="4" field="durchm" name="Durchmesser"/>
    <alias index="5" field="druckdicht" name="Druckdicht"/>
    <alias index="6" field="ueberstauflaeche" name="Überstaufläche"/>
    <alias index="7" field="entwart" name="Entwässerungssystem"/>
    <alias index="8" field="strasse" name="Straße"/>
    <alias index="9" field="baujahr" name=""/>
    <alias index="10" field="eigentum" name="Eigentümer"/>
    <alias index="11" field="teilgebiet" name="Teilgebiet"/>
    <alias index="12" field="knotentyp" name="Knotentyp"/>
    <alias index="13" field="auslasstyp" name="Auslasstyp"/>
    <alias index="14" field="schachttyp" name="Schachttyp"/>
    <alias index="15" field="simstatus" name="Planungsstatus"/>
    <alias index="16" field="material" name="Material"/>
    <alias index="17" field="xsch" name=""/>
    <alias index="18" field="ysch" name=""/>
    <alias index="19" field="kommentar" name="Kommentar"/>
    <alias index="20" field="createdat" name="erstellt"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="1" name="eigentum"/>
