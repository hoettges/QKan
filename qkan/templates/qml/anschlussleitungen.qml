...
<qgis simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyLocal="1" styleCategories="Symbology|Labeling|Fields|Forms|Actions|AttributeTable|Rendering" simplifyDrawingHints="1" version="3.16.5-Hannover" maxScale="0" minScale="100000000">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="leitnam">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <defaults>
    ...
    <default field="sohleoben" expression="" applyOnUpdate="0"/>
    <default field="sohleunten" expression="" applyOnUpdate="0"/>
    <default field="deckeloben" expression="" applyOnUpdate="0"/>
    <default field="deckelunten" expression="" applyOnUpdate="0"/>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:/Users/Nora/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/qkan/forms/anschlussleitungen.ui</editform>
  <editforminit/>
