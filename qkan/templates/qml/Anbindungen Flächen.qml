...
<qgis styleCategories="AllStyleCategories" maxScale="0" minScale="0" labelsEnabled="0" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" version="3.28.13-Firenze" simplifyDrawingHints="1" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1">
<flags>
        ...
        <symbols>
          <symbol alpha="1" is_animated="0" name="0" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="0">
              ...
              <symbol alpha="1" is_animated="0" name="@0@1" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
                ...
                <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
                  <Option type="Map">
                    <Option value="0" name="angle" type="QString"/>
                    <Option value="square" name="cap_style" type="QString"/>
                    <Option value="196,241,122,255" name="color" type="QString"/>
                    <Option value="1" name="horizontal_anchor_point" type="QString"/>
                    <Option value="bevel" name="joinstyle" type="QString"/>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="flnam" name="Key" type="QString"/>
                <Option value="Einzelfl_chen_7dbcb03c_6415_49c1_b295_0152f545904c" name="Layer" type="QString"/>
                <Option value="Einzelflächen" name="LayerName" type="QString"/>
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;flaechen&quot; (geom)" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="true" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
                <Option value="flnam" name="Value" type="QString"/>
              </Option>
            </config>
          </editWidget>
        </field>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="" name="FilterExpression" type="QString"/>
                <Option value="flnam" name="Key" type="QString"/>
                <Option value="Haltungsflächen_38cc9a58_a57d_487e_bbac_6000457b0748" name="Layer" type="QString"/>
                <Option value="Haltungsflächen" name="LayerName" type="QString"/>
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;tezg&quot; (geom)" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="true" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
                <Option value="flnam" name="Value" type="QString"/>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="" name="Description" type="QString"/>
                <Option value="" name="FilterExpression" type="QString"/>
                <Option value="abflusstyp" name="Key" type="QString"/>
                <Option value="abflussmodelle_b1368d23_11b7_4b53_86a9_44feb5d66c5f" name="Layer" type="QString"/>
                <Option value="Abflussmodelle" name="LayerName" type="QString"/>
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='./demo.sqlite' table=&quot;abflussmodelle&quot;" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="false" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
                <Option value="abflusstyp" name="Value" type="QString"/>
              </Option>
            </config>
          </editWidget>
        </field>
      ...
      <aliases>
        ...
        <alias field="tezgnam" index="4" name="Haltungsfläche"/>
        <alias field="teilgebiet" index="5" name="Teilgebiet"/>
        <alias field="abflusstyp" index="6" name="Abflussmodell"/>
        <alias field="speicherzahl" index="7" name="Speicherzahl"/>
        <alias field="speicherkonst" index="8" name="Speicherkonstante"/>
        <alias field="fliesszeitkanal" index="9" name="Fließzeit Kanal"/>
        <alias field="fliesszeitflaeche" index="10" name="Fließzeit Fläche"/>
        <alias field="geom" index="11" name=""/>
        <alias field="gbuf" index="12" name=""/>
      </aliases>
      <defaults>
        ...
        <default field="tezgnam" applyOnUpdate="0" expression=""/>
        <default field="teilgebiet" applyOnUpdate="0" expression=""/>
        <default field="abflusstyp" applyOnUpdate="0" expression=""/>
        <default field="speicherzahl" applyOnUpdate="0" expression=""/>
        <default field="speicherkonst" applyOnUpdate="0" expression=""/>
        <default field="fliesszeitkanal" applyOnUpdate="0" expression=""/>
        <default field="fliesszeitflaeche" applyOnUpdate="0" expression=""/>
      ...
      <constraints>
        ...
        <constraint field="flnam" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        ...
        <constraint field="tezgnam" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="teilgebiet" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="abflusstyp" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="speicherzahl" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="speicherkonst" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="fliesszeitkanal" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="fliesszeitflaeche" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="geom" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="gbuf" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
      </constraints>
      ...
      <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
        <columns>
          ...
          <column name="tezgnam" hidden="0" width="-1" type="field"/>
          <column name="teilgebiet" hidden="0" width="-1" type="field"/>
          <column name="abflusstyp" hidden="0" width="-1" type="field"/>
          <column name="speicherzahl" hidden="0" width="-1" type="field"/>
          <column name="speicherkonst" hidden="0" width="-1" type="field"/>
          <column name="fliesszeitkanal" hidden="0" width="-1" type="field"/>
          <column name="fliesszeitflaeche" hidden="0" width="-1" type="field"/>
          <column name="geom" hidden="0" width="-1" type="field"/>
          <column name="gbuf" hidden="0" width="-1" type="field"/>
      ...
      <reuseLastValue>
        ...
        <field name="fliesszeitflaeche" reuseLastValue="0"/>
        <field name="fliesszeitkanal" reuseLastValue="0"/>
        <field name="flnam" reuseLastValue="0"/>
        <field name="gbuf" reuseLastValue="0"/>
        <field name="geom" reuseLastValue="0"/>
        <field name="haltnam" reuseLastValue="0"/>
        <field name="pk" reuseLastValue="0"/>
        <field name="schnam" reuseLastValue="1"/>
        <field name="speicherkonst" reuseLastValue="0"/>
        <field name="speicherzahl" reuseLastValue="0"/>
        <field name="teilgebiet" reuseLastValue="0"/>
        <field name="tezgnam" reuseLastValue="0"/>
      </reuseLastValue>
