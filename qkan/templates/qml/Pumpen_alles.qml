...
<qgis simplifyAlgorithm="0" minScale="0" readOnly="0" simplifyDrawingHints="1" symbologyReferenceScale="-1" maxScale="0" simplifyLocal="1" version="3.24.1-Tisler" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyDrawingTol="1" simplifyMaxScale="1">
  <flags>
  ...
  <temporal durationField="pk" startField="" limitMode="0" enabled="0" mode="0" endField="" fixedDuration="0" durationUnit="min" startExpression="" endExpression="" accumulate="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
    ...
    <symbols>
      <symbol type="line" alpha="1" clip_to_extent="1" name="0" force_rhr="0">
        ...
        <layer pass="0" enabled="1" class="MarkerLine" locked="0">
          ...
          <symbol type="marker" alpha="1" clip_to_extent="1" name="@0@1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer pass="0" enabled="1" class="FontMarker" locked="0">
              <Option type="Map">
                ...
                <Option type="QString" value="255,21,21,255" name="color"/>
                <Option type="QString" value="Source Sans Pro" name="font"/>
                ...
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="name">
                      ...
                      <Option type="QString" value="'W'" name="expression"/>
        ...
        <layer pass="0" enabled="1" class="MarkerLine" locked="0">
          ...
          <symbol type="marker" alpha="1" clip_to_extent="1" name="@0@2" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option type="List" name="dualview/previewExpressions">
        <Option type="QString" value="&quot;pnam&quot;"/>
      </Option>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory width="15" spacing="5" scaleDependency="Area" height="15" spacingUnitScale="3x:0,0,0,0,0,0" penColor="#000000" opacity="1" diagramOrientation="Up" lineSizeType="MM" barWidth="5" maxScaleDenominator="0" penAlpha="255" showAxis="1" lineSizeScale="3x:0,0,0,0,0,0" enabled="0" direction="0" minScaleDenominator="0" sizeType="MM" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" scaleBasedVisibility="0" backgroundAlpha="255" spacingUnit="MM" backgroundColor="#ffffff" rotationOffset="270" minimumSize="0" penWidth="0">
  ...
  <DiagramLayerSettings obstacle="0" placement="2" zIndex="0" priority="0" showAll="1" linePlacementFlags="18" dist="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="hoehe" index="4" name="Öffnungshöhe (m)"/>
    <alias field="breite" index="5" name=""/>
    <alias field="laenge" index="6" name=""/>
    <alias field="sohleoben" index="7" name=""/>
    <alias field="sohleunten" index="8" name=""/>
    <alias field="deckeloben" index="9" name=""/>
    <alias field="deckelunten" index="10" name=""/>
    <alias field="teilgebiet" index="11" name="Teilgebiet"/>
    <alias field="qzu" index="12" name=""/>
    <alias field="profilnam" index="13" name=""/>
    <alias field="entwart" index="14" name="Entwässerungssystem"/>
    <alias field="material" index="15" name=""/>
    <alias field="ks" index="16" name=""/>
    <alias field="sonderelement" index="17" name="Sonderelementttyp"/>
    <alias field="simstatus" index="18" name="Planungsstatus"/>
    <alias field="kommentar" index="19" name="Kommentar"/>
    <alias field="createdat" index="20" name="erstellt"/>
    <alias field="xschob" index="21" name=""/>
    <alias field="yschob" index="22" name=""/>
    <alias field="xschun" index="23" name=""/>
    <alias field="yschun" index="24" name=""/>
  </aliases>
  <defaults>
    ...
    <default expression="'Pumpe'" applyOnUpdate="1" field="sonderelement"/>
    <default expression="" applyOnUpdate="0" field="simstatus"/>
    <default expression="''" applyOnUpdate="0" field="kommentar"/>
    <default expression=" format_date( now(), 'yyyy.MM.dd HH:mm:ss')" applyOnUpdate="1" field="createdat"/>
  ...
  <constraints>
    <constraint exp_strength="0" unique_strength="1" field="pk" constraints="3" notnull_strength="1"/>
    <constraint exp_strength="0" unique_strength="0" field="haltnam" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="schoben" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="schunten" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="hoehe" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="breite" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="laenge" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="sohleoben" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="sohleunten" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="deckeloben" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="deckelunten" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="teilgebiet" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="qzu" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="profilnam" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="entwart" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="material" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="ks" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="sonderelement" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="simstatus" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="kommentar" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="createdat" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="xschob" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="yschob" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="xschun" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="yschun" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="sonderelement" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" hidden="1" name="breite"/>
      ...
      <column width="-1" type="field" hidden="1" name="deckeloben"/>
      <column width="-1" type="field" hidden="1" name="deckelunten"/>
      <column width="-1" type="field" hidden="1" name="qzu"/>
      ...
      <column width="-1" type="field" hidden="0" name="sonderelement"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>"pnam"</previewExpression>
  <mapTip></mapTip>
