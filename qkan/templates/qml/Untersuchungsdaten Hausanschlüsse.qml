...
<qgis hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" symbologyReferenceScale="-1" simplifyDrawingTol="1" version="3.22.4-Białowieża" simplifyDrawingHints="1" maxScale="0" labelsEnabled="1" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|Temporal|Legend|Notes" minScale="100000000" simplifyMaxScale="1" simplifyLocal="1">
  ...
  <aliases>
    ...
    <alias index="1" field="untersuchleit" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="untersuchleit" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" field="untersuchleit" unique_strength="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" exp="" field="untersuchleit"/>
  ...
  <attributeactions>
    ...
    <actionsetting isEnabledOnlyWhenEditable="0" type="1" id="{b8a6ef63-40f5-4eb6-8b35-d05b36b01f7d}" notificationMessage="" name="Zustandsdaten für alle Hausanschussleitungen anzeigen" icon="" capture="0" shortTitle="Alle Zustandsdaten" action="from qkan.tools.zeige_haltungsschaeden import ShowHausanschlussschaeden&#xd;&#xa;&#xd;&#xa;form = ShowHausanschlussschaeden('[%untersuchleit%]')&#xd;&#xa;form.show()&#xd;&#xa;">
      <actionScope id="Feature"/>
      <actionScope id="Canvas"/>
    </actionsetting>
  </attributeactions>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:\Users/hoettges/AppData/Roaming/QGIS/QGIS3\profiles\default/python/plugins\qkan\forms\qkan_untersuchdat_anschlussleitung.ui</editform>
  <editforminit/>
