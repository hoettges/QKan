...
<qgis styleCategories="AllStyleCategories" maxScale="100000" minScale="100000000" labelsEnabled="1" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" version="3.28.13-Firenze" simplifyDrawingHints="0" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1">
<flags>
      ...
      <labeling type="simple">
        <settings calloutType="simple">
          <text-style fontLetterSpacing="0" fontItalic="0" capitalization="0" useSubstitutions="0" fontSize="0" fontWordSpacing="0" blendMode="0" allowHtml="0" forcedItalic="0" legendString="Aa" namedStyle="Standard" multilineHeightUnit="Percentage" fontSizeUnit="Point" textOpacity="1" fontUnderline="0" textOrientation="horizontal" fontWeight="50" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="MS Shell Dlg 2" forcedBold="0" fontStrikeout="0" fieldName="schnam" multilineHeight="1" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="51,160,44,255">
            <families/>
          ...
          <placement priority="5" placement="2" offsetUnits="MapUnit" overlapHandling="PreventOverlap" layerType="LineGeometry" centroidInside="0" polygonPlacementFlags="2" preserveRotation="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" overrunDistanceUnit="MM" lineAnchorTextPoint="CenterOfText" maxCurvedCharAngleOut="-20" geometryGeneratorType="PointGeometry" lineAnchorPercent="0" repeatDistanceUnits="MM" rotationAngle="0" maxCurvedCharAngleIn="20" geometryGeneratorEnabled="0" overrunDistance="0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" quadOffset="2" dist="1" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="-1" rotationUnit="AngleDegrees" lineAnchorClipping="0" allowDegraded="0" fitInPolygonOnly="0" distUnits="MM" lineAnchorType="0" centroidWhole="0"/>
          <rendering obstacleFactor="1" mergeLines="0" obstacleType="0" fontMaxPixelSize="10000" drawLabels="1" scaleMax="250" scaleVisibility="1" upsidedownLabels="0" fontLimitPixelSize="0" obstacle="1" minFeatureSize="0" limitNumLabels="0" scaleMin="1" fontMinPixelSize="3" unplacedVisibility="0" labelPerPart="0" zIndex="0" maxNumLabels="2000"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
              <Option name="properties"/>
      ...
      <aliases>
        ...
        <alias field="druckdicht" index="5" name="Druckdichtigkeit"/>
        <alias field="ueberstauflaeche" index="6" name="Überstaufläche"/>
        <alias field="entwart" index="7" name="Entwässerungsart"/>
        <alias field="strasse" index="8" name="Straße"/>
        <alias field="baujahr" index="9" name="Baujahr"/>
        ...
        <alias field="material" index="16" name="'vorhanden'"/>
        <alias field="xsch" index="17" name=""/>
        <alias field="ysch" index="18" name=""/>
        <alias field="kommentar" index="19" name="Kommentar"/>
        <alias field="createdat" index="20" name="bearbeitet"/>
        <alias field="geop" index="21" name=""/>
        <alias field="x" index="22" name=""/>
        <alias field="y" index="23" name=""/>
      </aliases>
      <defaults>
        ...
        <default field="geop" applyOnUpdate="0" expression=""/>
      ...
      <constraints>
        ...
        <constraint field="geop" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="x" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="y" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
      </constraints>
      ...
      <expressionfields>
        <field precision="0" name="x" comment="" subType="0" expression="x(centroid($geometry))" typeName="double precision" type="6" length="-1"/>
        <field precision="0" name="y" comment="" subType="0" expression="y(centroid($geometry))" typeName="double precision" type="6" length="-1"/>
      </expressionfields>
      <attributeactions>
      ...
      <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
        <columns>
          ...
          <column name="geop" hidden="0" width="-1" type="field"/>
      ...
      <reuseLastValue>
        ...
        <field name="baujahr" reuseLastValue="1"/>
