...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyAlgorithm="0" labelsEnabled="0" version="3.22.4-Białowieża" minScale="0" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="1" readOnly="0" simplifyMaxScale="1" simplifyLocal="1" styleCategories="AllStyleCategories">
  ...
  <customproperties>
    <Option type="Map">
      <Option name="dualview/previewExpressions" type="List">
        <Option value="&quot;pnam&quot;" type="QString"/>
      </Option>
  ...
  <fieldConfiguration>
    ...
    <field name="pnam" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
    ...
    <field name="pumpentyp" configurationFlags="None">
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            <Option value="false" name="AllowMulti" type="bool"/>
            ...
            <Option value="pumpentypen20161018090730556" name="Layer" type="QString"/>
            <Option value="Pumpentypen" name="LayerName" type="QString"/>
            <Option value="spatialite" name="LayerProviderName" type="QString"/>
            <Option value="dbname='C:/Users/User/Desktop/Hiwi Höttges/QGIS/muster.sqlite' table=&quot;pumpentypen&quot;" name="LayerSource" type="QString"/>
            <Option value="1" name="NofColumns" type="int"/>
            <Option value="false" name="OrderByValue" type="bool"/>
            <Option value="true" name="UseCompleter" type="bool"/>
    ...
    <field name="volanf" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" name="IsMultiline" type="bool"/>
    ...
    <field name="volges" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" name="IsMultiline" type="bool"/>
    ...
    <field name="sohle" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" name="IsMultiline" type="bool"/>
    ...
    <field name="steuersch" configurationFlags="None">
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            <Option value="false" name="AllowMulti" type="bool"/>
    ...
    <field name="einschalthoehe" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" name="IsMultiline" type="bool"/>
    ...
    <field name="ausschalthoehe" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" name="IsMultiline" type="bool"/>
  ...
  <aliases>
    ...
    <alias field="pnam" name="Name" index="1"/>
    <alias field="schoben" name="Anfangsschacht" index="2"/>
    <alias field="schunten" name="Endschacht" index="3"/>
    <alias field="pumpentyp" name="Pumpentyp" index="4"/>
    <alias field="volanf" name="" index="5"/>
    <alias field="volges" name="" index="6"/>
    <alias field="sohle" name="Sohlhöhe" index="7"/>
    <alias field="steuersch" name="" index="8"/>
    <alias field="einschalthoehe" name="Einschalthöhe" index="9"/>
    <alias field="ausschalthoehe" name="Ausschalthöhe" index="10"/>
  ...
  <defaults>
    ...
    <default field="pnam" applyOnUpdate="0" expression=""/>
    <default field="schoben" applyOnUpdate="0" expression=""/>
    <default field="schunten" applyOnUpdate="0" expression=""/>
    <default field="pumpentyp" applyOnUpdate="0" expression=""/>
    <default field="volanf" applyOnUpdate="0" expression=""/>
    <default field="volges" applyOnUpdate="0" expression=""/>
    <default field="sohle" applyOnUpdate="0" expression=""/>
    <default field="steuersch" applyOnUpdate="0" expression=""/>
    <default field="einschalthoehe" applyOnUpdate="0" expression=""/>
    <default field="ausschalthoehe" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="pnam" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint field="pumpentyp" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="volanf" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="volges" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="sohle" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="steuersch" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="einschalthoehe" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="ausschalthoehe" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="pnam" type="field" hidden="0" width="-1"/>
      <column name="schoben" type="field" hidden="0" width="-1"/>
      <column name="schunten" type="field" hidden="0" width="-1"/>
      <column name="pumpentyp" type="field" hidden="0" width="-1"/>
      <column name="volanf" type="field" hidden="0" width="-1"/>
      <column name="volges" type="field" hidden="0" width="-1"/>
      <column name="sohle" type="field" hidden="0" width="-1"/>
      <column name="steuersch" type="field" hidden="0" width="-1"/>
      <column name="einschalthoehe" type="field" hidden="0" width="-1"/>
      <column name="ausschalthoehe" type="field" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="ausschalthoehe" editable="1"/>
    <field name="createdat" editable="1"/>
    <field name="einschalthoehe" editable="1"/>
    <field name="kommentar" editable="1"/>
    <field name="pk" editable="1"/>
    <field name="pnam" editable="1"/>
    <field name="pumpentyp" editable="1"/>
    <field name="schoben" editable="1"/>
    <field name="schunten" editable="1"/>
    <field name="simstatus" editable="1"/>
    <field name="sohle" editable="1"/>
    <field name="steuersch" editable="1"/>
    <field name="teilgebiet" editable="1"/>
    <field name="volanf" editable="1"/>
    <field name="volges" editable="1"/>
  </editable>
  <labelOnTop>
  ...
  <reuseLastValue>
    <field name="ausschalthoehe" reuseLastValue="0"/>
    <field name="createdat" reuseLastValue="0"/>
    <field name="einschalthoehe" reuseLastValue="0"/>
    <field name="kommentar" reuseLastValue="0"/>
    <field name="pk" reuseLastValue="0"/>
    <field name="pnam" reuseLastValue="0"/>
    <field name="pumpentyp" reuseLastValue="0"/>
    <field name="schoben" reuseLastValue="0"/>
    <field name="schunten" reuseLastValue="0"/>
    <field name="simstatus" reuseLastValue="0"/>
    <field name="sohle" reuseLastValue="0"/>
    <field name="steuersch" reuseLastValue="0"/>
    <field name="teilgebiet" reuseLastValue="0"/>
    <field name="volanf" reuseLastValue="0"/>
    <field name="volges" reuseLastValue="0"/>
  </reuseLastValue>
