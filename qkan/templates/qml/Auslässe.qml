...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyAlgorithm="0" labelsEnabled="1" version="3.22.4-Białowieża" minScale="100000000" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="0" readOnly="0" simplifyMaxScale="1" simplifyLocal="1" styleCategories="AllStyleCategories">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style blendMode="0" legendString="Aa" fieldName="schnam" textOpacity="1" fontItalic="0" textColor="168,81,0,255" fontKerning="1" multilineHeight="1" fontUnderline="1" isExpression="0" allowHtml="0" textOrientation="horizontal" fontWordSpacing="0" fontSize="10" fontFamily="MS Shell Dlg 2" fontWeight="75" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Bold" previewBkgrdColor="255,255,255,255" useSubstitutions="0" capitalization="0" fontSizeUnit="Point" fontLetterSpacing="0" fontStrikeout="0">
        <families/>
        <text-buffer bufferNoFill="0" bufferBlendMode="0" bufferSizeUnits="MM" bufferDraw="1" bufferSize="1" bufferJoinStyle="128" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255"/>
        <text-mask maskedSymbolLayers="" maskSize="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskType="0" maskJoinStyle="128" maskSizeUnits="MM" maskEnabled="0"/>
        <background shapeOffsetUnit="MM" shapeRotation="0" shapeRotationType="0" shapeBorderWidthUnit="MM" shapeOpacity="1" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="MM" shapeFillColor="255,255,255,255" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255" shapeRadiiY="0" shapeSizeX="0" shapeRadiiX="0" shapeBlendMode="0" shapeSizeType="0" shapeType="0" shapeOffsetX="0" shapeSizeY="0" shapeOffsetY="0" shapeSVGFile="" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeJoinStyle="64" shapeBorderWidth="0">
          ...
          <symbol alpha="1" name="fillSymbol" clip_to_extent="1" type="fill" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <shadow shadowDraw="0" shadowRadiusAlphaOnly="0" shadowOffsetDist="1" shadowScale="100" shadowColor="0,0,0,255" shadowUnder="0" shadowOffsetAngle="135" shadowOffsetUnit="MM" shadowOpacity="0" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowRadius="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetGlobal="1" shadowBlendMode="6" shadowRadiusUnit="MM"/>
        <dd_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format autoWrapLength="0" wrapChar="" addDirectionSymbol="0" leftDirectionSymbol="&lt;" plussign="0" useMaxLineLengthForAutoWrap="1" placeDirectionSymbol="0" rightDirectionSymbol=">" formatNumbers="0" reverseDirectionSymbol="0" multilineAlign="3" decimals="3"/>
      <placement fitInPolygonOnly="0" distMapUnitScale="3x:0,0,0,0,0,0" priority="7" centroidInside="0" lineAnchorClipping="0" geometryGenerator="" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" dist="3" quadOffset="4" maxCurvedCharAngleOut="-25" lineAnchorPercent="0" rotationUnit="AngleDegrees" yOffset="0" placement="6" geometryGeneratorEnabled="0" offsetType="0" overrunDistance="0" placementFlags="10" centroidWhole="0" offsetUnits="MapUnit" layerType="PointGeometry" polygonPlacementFlags="2" repeatDistance="0" preserveRotation="1" distUnits="MM" geometryGeneratorType="PointGeometry" maxCurvedCharAngleIn="25" rotationAngle="0" lineAnchorType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM"/>
      <rendering scaleMax="20000" unplacedVisibility="0" upsidedownLabels="0" obstacle="1" displayAll="0" labelPerPart="0" obstacleFactor="1" scaleVisibility="1" obstacleType="0" drawLabels="1" mergeLines="0" minFeatureSize="0" fontMaxPixelSize="10000" zIndex="0" limitNumLabels="0" fontLimitPixelSize="0" maxNumLabels="2000" fontMinPixelSize="3" scaleMin="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="spatialite" name="LayerProviderName" type="QString"/>
            <Option value="dbname='C:/Users/User/Desktop/Hiwi Höttges/QGIS/muster.sqlite' table=&quot;auslasstypen&quot;" name="LayerSource" type="QString"/>
            <Option value="1" name="NofColumns" type="int"/>
            <Option value="false" name="OrderByValue" type="bool"/>
            <Option value="true" name="UseCompleter" type="bool"/>
            <Option value="bezeichnung" name="Value" type="QString"/>
  ...
  <aliases>
    ...
    <alias field="x" name="" index="20"/>
    <alias field="y" name="" index="21"/>
  </aliases>
  <defaults>
  ...
  <expressionfields>
    <field name="x" subType="0" length="-1" type="6" precision="0" typeName="double precision" expression="$x" comment=""/>
    <field name="y" subType="0" length="-1" type="6" precision="0" typeName="double precision" expression="$y" comment=""/>
    <field name="x" subType="0" length="0" type="6" precision="0" typeName="" expression="$x" comment=""/>
    <field name="y" subType="0" length="0" type="6" precision="0" typeName="" expression="$y" comment=""/>
  </expressionfields>
  <attributeactions>
    <defaultAction value="{00000000-0000-0000-0000-000000000000}" key="Canvas"/>
  </attributeactions>
  <attributetableconfig sortExpression="&quot;pk&quot;" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
