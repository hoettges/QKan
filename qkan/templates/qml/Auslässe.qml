...
<qgis version="3.24.1-Tisler" readOnly="0" simplifyMaxScale="1" maxScale="0" symbologyReferenceScale="-1" minScale="100000000" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyAlgorithm="0" labelsEnabled="1">
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory labelPlacementMethod="XHeight" scaleDependency="Area" showAxis="0" spacingUnit="MM" opacity="1" barWidth="5" scaleBasedVisibility="0" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="0" penWidth="0" direction="1" rotationOffset="270" lineSizeType="MM" penColor="#000000" spacing="0" diagramOrientation="Up" maxScaleDenominator="1e+08" spacingUnitScale="3x:0,0,0,0,0,0" lineSizeScale="3x:0,0,0,0,0,0" height="15" sizeType="MM" minimumSize="0" width="15" penAlpha="255" backgroundAlpha="255" enabled="0" backgroundColor="#ffffff">
  ...
  <defaults>
    ...
    <default expression="frei" applyOnUpdate="0" field="auslasstyp"/>
    <default expression="'Auslass'" applyOnUpdate="0" field="schachttyp"/>
  ...
  <expressionfields>
    <field expression="$x" name="x" precision="0" type="6" comment="" subType="0" length="-1" typeName="double precision"/>
    <field expression="$y" name="y" precision="0" type="6" comment="" subType="0" length="-1" typeName="double precision"/>
    <field expression="$x" name="x" precision="0" type="6" comment="" subType="0" length="0" typeName=""/>
    <field expression="$y" name="y" precision="0" type="6" comment="" subType="0" length="0" typeName=""/>
  </expressionfields>
  <attributeactions>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:/FHAC/hoettges/Kanalprogramme/hoettges/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/qkan/forms/qkan_auslaesse.ui</editform>
  <editforminit/>
