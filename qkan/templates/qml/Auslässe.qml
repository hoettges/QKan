...
<flags>
      ...
      <labeling type="simple">
        <settings calloutType="simple">
          <text-style fontLetterSpacing="0" fontItalic="0" capitalization="0" useSubstitutions="0" fontSize="10" fontWordSpacing="0" blendMode="0" allowHtml="0" forcedItalic="0" legendString="Aa" namedStyle="Bold" multilineHeightUnit="Percentage" fontSizeUnit="Point" textOpacity="1" fontUnderline="1" textOrientation="horizontal" fontWeight="75" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="MS Shell Dlg 2" forcedBold="0" fontStrikeout="0" fieldName="schnam" multilineHeight="1" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="168,81,0,255">
            <families/>
            <text-buffer bufferSizeUnits="MM" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferDraw="1" bufferSize="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="128"/>
          ...
          <placement priority="7" placement="6" offsetUnits="MapUnit" overlapHandling="PreventOverlap" layerType="PointGeometry" centroidInside="0" polygonPlacementFlags="2" preserveRotation="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" overrunDistanceUnit="MM" lineAnchorTextPoint="CenterOfText" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" lineAnchorPercent="0" repeatDistanceUnits="MM" rotationAngle="0" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="0" overrunDistance="0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" quadOffset="4" dist="3" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" rotationUnit="AngleDegrees" lineAnchorClipping="0" allowDegraded="0" fitInPolygonOnly="0" distUnits="MM" lineAnchorType="0" centroidWhole="0"/>
          <rendering obstacleFactor="1" mergeLines="0" obstacleType="0" fontMaxPixelSize="10000" drawLabels="1" scaleMax="20000" scaleVisibility="1" upsidedownLabels="0" fontLimitPixelSize="0" obstacle="1" minFeatureSize="0" limitNumLabels="0" scaleMin="1" fontMinPixelSize="3" unplacedVisibility="0" labelPerPart="0" zIndex="0" maxNumLabels="2000"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
              <Option name="properties"/>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="" name="FilterExpression" type="QString"/>
                <Option value="bezeichnung" name="Key" type="QString"/>
                <Option value="auslasstypen20161201095045204" name="Layer" type="QString"/>
                <Option value="Auslasstypen" name="LayerName" type="QString"/>
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;auslasstypen&quot;" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="false" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
                <Option value="bezeichnung" name="Value" type="QString"/>
          ...
          <editWidget type="TextEdit">
            <config>
              <Option type="Map">
                ...
                <Option value="false" name="UseHtml" type="QString"/>
              </Option>
            </config>
          </editWidget>
        </field>
      ...
      <aliases>
        ...
        <alias field="eigentum" index="10" name=""/>
      ...
      <defaults>
        ...
        <default field="auslasstyp" applyOnUpdate="0" expression="frei"/>
        <default field="schachttyp" applyOnUpdate="0" expression="'Auslass'"/>
      ...
      <expressionfields>
        <field precision="0" name="x" comment="" subType="0" expression="$x" typeName="double precision" type="6" length="-1"/>
        <field precision="0" name="y" comment="" subType="0" expression="$y" typeName="double precision" type="6" length="-1"/>
        <field precision="0" name="x" comment="" subType="0" expression="$x" typeName="" type="6" length="0"/>
        <field precision="0" name="y" comment="" subType="0" expression="$y" typeName="" type="6" length="0"/>
      </expressionfields>
      <attributeactions>
        <defaultAction value="{00000000-0000-0000-0000-000000000000}" key="Canvas"/>
      </attributeactions>
      <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="&quot;pk&quot;">
        <columns>
