...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" version="3.20.1-Odense" simplifyMaxScale="1" minScale="0" readOnly="0" simplifyDrawingHints="1" labelsEnabled="0">
    ...
    <symbols>
      <symbol type="line" alpha="1" clip_to_extent="1" force_rhr="0" name="0">
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          ...
          <symbol type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="@0@1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="FontMarker" pass="0" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option value="Arial Rounded MT Bold" type="QString" name="font"/>
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="firstvertex" type="QString" name="placement"/>
            <Option value="0" type="QString" name="ring_filter"/>
        ...
        <layer class="MarkerLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
            <Option value="lastvertex" type="QString" name="placement"/>
            <Option value="0" type="QString" name="ring_filter"/>
            <Option value="1" type="QString" name="rotate"/>
          </Option>
          <prop v="4" k="average_angle_length"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option value="COALESCE( &quot;wnam&quot;, '&lt;NULL>' )" type="QString" name="dualview/previewExpressions"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="true" type="QString" name="AllowNull"/>
            ...
            <Option value="true" type="QString" name="UseCompleter"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="wnam" constraints="0"/>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="wehrtyp" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="schwellenhoehe" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="kammerhoehe" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="laenge" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="uebeiwert" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="aussentyp" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="aussenwsp" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="wnam"/>
    <constraint exp="" desc="" field="schoben"/>
    <constraint exp="" desc="" field="schunten"/>
    <constraint exp="" desc="" field="wehrtyp"/>
    <constraint exp="" desc="" field="schwellenhoehe"/>
    <constraint exp="" desc="" field="kammerhoehe"/>
    <constraint exp="" desc="" field="laenge"/>
    <constraint exp="" desc="" field="uebeiwert"/>
    <constraint exp="" desc="" field="aussentyp"/>
    <constraint exp="" desc="" field="aussenwsp"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" hidden="0" name="wnam" width="-1"/>
      <column type="field" hidden="0" name="schoben" width="-1"/>
      <column type="field" hidden="0" name="schunten" width="-1"/>
      <column type="field" hidden="0" name="wehrtyp" width="-1"/>
      <column type="field" hidden="0" name="schwellenhoehe" width="-1"/>
      <column type="field" hidden="0" name="kammerhoehe" width="-1"/>
      <column type="field" hidden="0" name="laenge" width="-1"/>
      <column type="field" hidden="0" name="uebeiwert" width="-1"/>
      <column type="field" hidden="0" name="aussentyp" width="-1"/>
      <column type="field" hidden="0" name="aussenwsp" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    <field name="aussentyp" reuseLastValue="0"/>
    <field name="aussenwsp" reuseLastValue="0"/>
    <field name="createdat" reuseLastValue="0"/>
    <field name="kammerhoehe" reuseLastValue="0"/>
    ...
    <field name="schwellenhoehe" reuseLastValue="0"/>
    <field name="simstatus" reuseLastValue="0"/>
    <field name="teilgebiet" reuseLastValue="0"/>
    <field name="uebeiwert" reuseLastValue="0"/>
    <field name="wehrtyp" reuseLastValue="0"/>
    <field name="wnam" reuseLastValue="0"/>
  </reuseLastValue>
