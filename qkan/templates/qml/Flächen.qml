...
<qgis simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" version="3.20.1-Odense" simplifyMaxScale="1" minScale="0" readOnly="0" simplifyDrawingHints="1" labelsEnabled="0">
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" enableorderby="0" attr="abflussparameter" symbollevels="0">
    <categories>
      <category value="" label="" render="true" symbol="0"/>
      <category value="$Default_Bef" label="$Default_Bef" render="true" symbol="1"/>
      <category value="Dach" label="Dach" render="true" symbol="2"/>
      <category value="Strasse" label="Strasse" render="true" symbol="3"/>
      <category value="$Default_Unbef" label="$Default_Unbef" render="true" symbol="4"/>
    </categories>
    <symbols>
      <symbol type="fill" alpha="0.666667" clip_to_extent="1" force_rhr="0" name="0">
        ...
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <Option type="Map">
            ...
            <Option value="197,164,243,255" type="QString" name="color"/>
      ...
      <symbol type="fill" alpha="0.666667" clip_to_extent="1" force_rhr="0" name="3">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
          ...
          <symbol type="marker" alpha="1" clip_to_extent="1" force_rhr="0" name="@4@1">
            ...
            <layer class="SimpleMarker" pass="0" enabled="1" locked="0">
              <Option type="Map">
                ...
                <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
                <Option value="MM" type="QString" name="offset_unit"/>
                <Option value="239,252,208,255" type="QString" name="outline_color"/>
                <Option value="solid" type="QString" name="outline_style"/>
                <Option value="0" type="QString" name="outline_width"/>
                <Option value="3x:0,0,0,0,0,0" type="QString" name="outline_width_map_unit_scale"/>
                <Option value="MM" type="QString" name="outline_width_unit"/>
    ...
    <source-symbol>
      <symbol type="fill" alpha="0.313725" clip_to_extent="1" force_rhr="0" name="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option type="StringList" name="dualview/previewExpressions">
        <Option value="COALESCE( &quot;flnam&quot;, '&lt;NULL>' )" type="QString"/>
        <Option value="COALESCE( &quot;flnam&quot;, '&lt;NULL>' )" type="QString"/>
      </Option>
  ...
  <fieldConfiguration>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="haltungen_Kopie20161016203906444" type="QString" name="Layer"/>
            <Option value="Haltungslinien" type="QString" name="LayerName"/>
            <Option value="spatialite" type="QString" name="LayerProviderName"/>
            <Option value="dbname='C:/Users/hoettges/Documents/QKan/qgis/projekt.sqlite' table=&quot;haltungen&quot; (geom)" type="QString" name="LayerSource"/>
    ...
    <field name="aufteilen" configurationFlags="None">
      <editWidget type="CheckBox">
        <config>
          <Option type="Map">
            <Option value="ja" type="QString" name="CheckedState"/>
  ...
  <aliases>
    ...
    <alias index="3" field="neigkl" name=""/>
    <alias index="4" field="teilgebiet" name=""/>
    <alias index="5" field="regenschreiber" name=""/>
    <alias index="6" field="abflussparameter" name=""/>
    <alias index="7" field="aufteilen" name=""/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="flnam" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="haltnam" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="neigkl" constraints="0"/>
    ...
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="abflussparameter" constraints="0"/>
    <constraint notnull_strength="0" unique_strength="0" exp_strength="0" field="aufteilen" constraints="0"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" hidden="0" name="flnam" width="-1"/>
      <column type="field" hidden="0" name="haltnam" width="-1"/>
      <column type="field" hidden="0" name="neigkl" width="-1"/>
      <column type="field" hidden="0" name="teilgebiet" width="-1"/>
      <column type="field" hidden="0" name="regenschreiber" width="-1"/>
      <column type="field" hidden="0" name="abflussparameter" width="-1"/>
      <column type="field" hidden="0" name="aufteilen" width="-1"/>
