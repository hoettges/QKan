...
<qgis simplifyMaxScale="1" symbologyReferenceScale="-1" version="3.22.4-Białowieża" hasScaleBasedVisibilityFlag="1" readOnly="0" minScale="15000" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyLocal="1" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingTol="1" labelsEnabled="0">
  <flags>
  ...
  <aliases>
    ...
    <alias index="5" field="breite" name="Breite"/>
    <alias index="6" field="laenge" name="Länge"/>
    <alias index="7" field="sohleoben" name="Sohlhöhe Anfang"/>
    <alias index="8" field="sohleunten" name="Sohlhöhe Ende"/>
    ...
    <alias index="21" field="xschob" name="x_anf"/>
    <alias index="22" field="yschob" name="y_anf"/>
    <alias index="23" field="xschun" name="x_end"/>
    <alias index="24" field="yschun" name="y_end"/>
  </aliases>
  <defaults>
    ...
    <default expression="'Drossel'" field="sonderelement" applyOnUpdate="1"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" hidden="1" type="field" name="hoehe"/>
      <column width="-1" hidden="1" type="field" name="breite"/>
      ...
      <column width="223" hidden="0" type="field" name="entwart"/>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:/FHAC/hoettges/Kanalprogramme/k_qkan/k_he8qk/beispiele/Users/hoettges/AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins/qkan/forms/qkan_drossel.ui</editform>
  <editforminit/>
