...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" minScale="0" version="3.22.4-Białowieża" readOnly="0" styleCategories="AllStyleCategories">
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="bodenklasse">
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            <Option type="QString" value="false" name="AllowMulti"/>
            ...
            <Option type="QString" value="1" name="NofColumns"/>
            <Option type="QString" value="false" name="OrderByValue"/>
            <Option type="QString" value="false" name="UseCompleter"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="-1" name="anfangsabflussbeiwert" hidden="1"/>
      <column type="field" width="-1" name="endabflussbeiwert" hidden="0"/>
      <column type="field" width="-1" name="benetzungsverlust" hidden="1"/>
      <column type="field" width="-1" name="muldenverlust" hidden="1"/>
      <column type="field" width="-1" name="benetzung_startwert" hidden="1"/>
      <column type="field" width="-1" name="mulden_startwert" hidden="1"/>
      ...
      <column type="field" width="-1" name="flaechentyp" hidden="1"/>
