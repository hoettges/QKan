...
<qgis styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="0" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" version="3.28.13-Firenze" simplifyDrawingHints="0" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyMaxScale="1">
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="bknam" name="Key" type="QString"/>
            <Option value="bodenklassen20170516122309914" name="Layer" type="QString"/>
            <Option value="Bodenart" name="LayerName" type="QString"/>
            <Option value="spatialite" name="LayerProviderName" type="QString"/>
            <Option value="dbname='demo.sqlite' table=&quot;bodenklassen&quot;" name="LayerSource" type="QString"/>
            <Option value="1" name="NofColumns" type="int"/>
            <Option value="true" name="OrderByValue" type="bool"/>
            <Option value="false" name="UseCompleter" type="bool"/>
            <Option value="bknam" name="Value" type="QString"/>
          </Option>
        </config>
      </editWidget>
    </field>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="flaechentypen_ca71f66a_50bb_41cb_86df_8046fae64926" name="Layer" type="QString"/>
            <Option value="Flächentypen" name="LayerName" type="QString"/>
            <Option value="spatialite" name="LayerProviderName" type="QString"/>
            <Option value="dbname='demo.sqlite' table=&quot;flaechentypen&quot;" name="LayerSource" type="QString"/>
            <Option value="1" name="NofColumns" type="int"/>
  ...
  <constraints>
    ...
    <constraint field="apnam" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="anfangsabflussbeiwert" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="endabflussbeiwert" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="benetzungsverlust" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="muldenverlust" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="benetzung_startwert" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="mulden_startwert" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="rauheit_kst" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="pctZero" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="bodenklasse" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="flaechentyp" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
