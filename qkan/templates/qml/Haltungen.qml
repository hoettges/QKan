...
<qgis styleCategories="AllStyleCategories" maxScale="1" minScale="0" labelsEnabled="1" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" version="3.28.13-Firenze" simplifyDrawingHints="0" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="1" simplifyDrawingTol="1" simplifyMaxScale="1">
<flags>
      ...
      <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" type="RuleRenderer" symbollevels="0">
        <rules key="{228d5431-8f44-40a0-9f32-4ab249f2b5b8}">
          <rule label="> 1:500" key="{7a315328-c986-4768-8f34-85184ac94014}" scalemaxdenom="500">
            ...
            <rule label="Rinnen/Gräben" key="{07e8a2eb-9665-435c-8e87-2c69926e09ac}" filter="&quot;entwart&quot; = 'Rinnen/Gräben'" symbol="3"/>
            <rule label="stillgelegt" key="{27ab1c10-b535-4e51-ae40-b7c256e6bd00}" filter="simstatus IN ('außer Betrieb', 'stillgelegt', 'verdämmert', 'fiktiv', 'rückgebaut')" symbol="4"/>
            <rule label="sonstige" description="sonstige" key="{783b79a0-fe47-4163-a434-b1e06b96cacd}" filter="ELSE" symbol="5"/>
          </rule>
          <rule label="1:500 bis 1:10.000" scalemindenom="500" key="{e05438f5-a656-42d1-ac7f-8028b529f31d}" scalemaxdenom="10000">
            <rule label="Mischwasser" key="{1660e41a-bcee-4000-851b-4ffbd84f067b}" filter="&quot;entwart&quot; = 'Mischwasser'" symbol="6"/>
            <rule label="Regenwasser" key="{6b527d4e-ae32-40c2-8dfc-07c45c96098b}" filter="&quot;entwart&quot; = 'Regenwasser'" symbol="7"/>
            <rule label="Schmutzwasser" key="{e5931154-729e-447c-9f78-f9ab4891db9b}" filter="&quot;entwart&quot; = 'Schmutzwasser'" symbol="8"/>
            <rule label="Rinnen/Gräben" key="{0c427e9f-b674-46d8-b28a-0b704f7beffb}" filter="&quot;entwart&quot; = 'Rinnen/Gräben'" symbol="9"/>
            <rule label="stillgelegt" key="{fc37676f-3d16-410e-84a2-40bf9ccf47d0}" filter="simstatus IN ('außer Betrieb', 'stillgelegt', 'verdämmert', 'fiktiv', 'rückgebaut')" symbol="10"/>
            <rule label="sonstige" description="sonstige" key="{dc84e2e3-93cd-49f9-ac6a-c1b72754a900}" filter="ELSE" symbol="11"/>
          </rule>
          <rule label="&lt; 1:10.000" description="weit entfernt" scalemindenom="10000" key="{2d10dc81-3792-478e-9fdb-6ab4a4cb14f1}" filter="True" symbol="12"/>
        </rules>
        <symbols>
          <symbol alpha="1" is_animated="0" name="0" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            ...
            <layer locked="0" enabled="1" class="SimpleLine" pass="1">
              <Option type="Map">
                ...
                <Option value="0" name="draw_inside_polygon" type="QString"/>
                <Option value="round" name="joinstyle" type="QString"/>
                <Option value="173,61,224,255" name="line_color" type="QString"/>
                <Option value="solid" name="line_style" type="QString"/>
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@0@2" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
                ...
                <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
                  <Option type="Map">
                    <Option value="0" name="angle" type="QString"/>
                    <Option value="square" name="cap_style" type="QString"/>
                    <Option value="173,61,224,255" name="color" type="QString"/>
                    <Option value="1" name="horizontal_anchor_point" type="QString"/>
                    <Option value="bevel" name="joinstyle" type="QString"/>
          ...
          <symbol alpha="1" is_animated="0" name="1" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            ...
            <layer locked="0" enabled="1" class="SimpleLine" pass="1">
              <Option type="Map">
                ...
                <Option value="0" name="draw_inside_polygon" type="QString"/>
                <Option value="round" name="joinstyle" type="QString"/>
                <Option value="0,63,255,255" name="line_color" type="QString"/>
                <Option value="solid" name="line_style" type="QString"/>
                <Option value="1" name="line_width" type="QString"/>
                <Option value="RenderMetersInMapUnits" name="line_width_unit" type="QString"/>
                <Option value="0" name="offset" type="QString"/>
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@1@2" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
                ...
                <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
                  <Option type="Map">
                    <Option value="0" name="angle" type="QString"/>
                    <Option value="square" name="cap_style" type="QString"/>
                    <Option value="0,63,255,255" name="color" type="QString"/>
                    <Option value="1" name="horizontal_anchor_point" type="QString"/>
                    <Option value="bevel" name="joinstyle" type="QString"/>
                    <Option value="filled_arrowhead" name="name" type="QString"/>
                    <Option value="0,0" name="offset" type="QString"/>
          ...
          <symbol alpha="1" is_animated="0" name="10" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@10@0" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
                ...
                <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
                  <Option type="Map">
                    ...
                    <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
                    <Option value="RenderMetersInMapUnits" name="offset_unit" type="QString"/>
                    <Option value="255,21,21,255" name="outline_color" type="QString"/>
                    <Option value="solid" name="outline_style" type="QString"/>
          ...
          <symbol alpha="1" is_animated="0" name="11" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" enabled="1" class="SimpleLine" pass="1">
              <Option type="Map">
                ...
                <Option value="0" name="draw_inside_polygon" type="QString"/>
                <Option value="round" name="joinstyle" type="QString"/>
                <Option value="127,127,127,255" name="line_color" type="QString"/>
                <Option value="solid" name="line_style" type="QString"/>
                <Option value="1" name="line_width" type="QString"/>
                <Option value="MM" name="line_width_unit" type="QString"/>
                <Option value="0" name="offset" type="QString"/>
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@11@2" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
                ...
                <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
                  <Option type="Map">
                    <Option value="0" name="angle" type="QString"/>
                    <Option value="square" name="cap_style" type="QString"/>
                    <Option value="203,203,203,255" name="color" type="QString"/>
                    <Option value="1" name="horizontal_anchor_point" type="QString"/>
                    <Option value="bevel" name="joinstyle" type="QString"/>
                    <Option value="filled_arrowhead" name="name" type="QString"/>
                    <Option value="0,0" name="offset" type="QString"/>
          ...
          <symbol alpha="1" is_animated="0" name="12" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
          ...
          <symbol alpha="1" is_animated="0" name="2" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@2@2" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
          ...
          <symbol alpha="1" is_animated="0" name="4" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@4@0" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
          ...
          <symbol alpha="1" is_animated="0" name="5" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@5@2" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
          ...
          <symbol alpha="1" is_animated="0" name="6" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            ...
            <layer locked="0" enabled="1" class="SimpleLine" pass="1">
              <Option type="Map">
                ...
                <Option value="5;2;2;2" name="customdash" type="QString"/>
                <Option value="3x:0,0,0,0,0,0" name="customdash_map_unit_scale" type="QString"/>
                <Option value="MM" name="customdash_unit" type="QString"/>
                <Option value="0" name="dash_pattern_offset" type="QString"/>
                <Option value="3x:0,0,0,0,0,0" name="dash_pattern_offset_map_unit_scale" type="QString"/>
                ...
                <Option value="174,0,254,255" name="line_color" type="QString"/>
                <Option value="solid" name="line_style" type="QString"/>
                <Option value="1" name="line_width" type="QString"/>
                <Option value="MM" name="line_width_unit" type="QString"/>
                <Option value="0" name="offset" type="QString"/>
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@6@1" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
          ...
          <symbol alpha="1" is_animated="0" name="7" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@7@1" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
          ...
          <symbol alpha="1" is_animated="0" name="8" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="2">
              ...
              <symbol alpha="1" is_animated="0" name="@8@1" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                <data_defined_properties>
                  <Option type="Map">
                    <Option value="" name="name" type="QString"/>
                    <Option name="properties"/>
          ...
          <symbol alpha="1" is_animated="0" name="9" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <labeling type="rule-based">
        <rules key="{247d1365-852c-4eed-8e0e-0bb338b1f2f1}">
          <rule description="Beschriftung Kreisquerschnitt 1:1000" key="{cdd84e78-ef54-4656-97f7-e43fe05b460b}" scalemaxdenom="1000">
            <settings calloutType="simple">
              <text-style fontLetterSpacing="0" fontItalic="0" capitalization="0" useSubstitutions="0" fontSize="9" fontWordSpacing="0" blendMode="0" allowHtml="0" forcedItalic="0" legendString="Aa" namedStyle="Standard" multilineHeightUnit="Percentage" fontSizeUnit="Point" textOpacity="1" fontUnderline="0" textOrientation="horizontal" fontWeight="50" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="MS Shell Dlg 2" forcedBold="0" fontStrikeout="0" fieldName="&quot;haltnam&quot; || '  -  ' || &quot;profilnam&quot;  || '  -  ' ||'DN ' || format_number(hoehe,0) || '  -  ' || format_number(((( sohleoben - sohleunten ) /  laenge )*1000),1) || ' ‰'" multilineHeight="1" isExpression="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="0,0,0,255">
                <families/>
                <text-buffer bufferSizeUnits="MM" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferDraw="1" bufferSize="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferJoinStyle="64"/>
                <text-mask maskSizeUnits="MM" maskedSymbolLayers="" maskJoinStyle="128" maskSize="0" maskOpacity="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0"/>
                <background shapeSizeUnit="MM" shapeSVGFile="" shapeRotation="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeBorderColor="128,128,128,255" shapeOpacity="1" shapeType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeOffsetX="0" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeRadiiX="0" shapeRadiiUnit="MM" shapeSizeX="0" shapeOffsetY="0" shapeRadiiY="0" shapeJoinStyle="64" shapeOffsetUnit="MM" shapeDraw="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeBorderWidth="0" shapeBlendMode="0">
              ...
              <placement priority="5" placement="2" offsetUnits="MapUnit" overlapHandling="PreventOverlap" layerType="LineGeometry" centroidInside="0" polygonPlacementFlags="2" preserveRotation="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" overrunDistanceUnit="MM" lineAnchorTextPoint="CenterOfText" maxCurvedCharAngleOut="-20" geometryGeneratorType="PointGeometry" lineAnchorPercent="0.5" repeatDistanceUnits="MM" rotationAngle="0" maxCurvedCharAngleIn="20" geometryGeneratorEnabled="0" overrunDistance="0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" quadOffset="4" dist="2" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" rotationUnit="AngleDegrees" lineAnchorClipping="0" allowDegraded="0" fitInPolygonOnly="0" distUnits="MM" lineAnchorType="0" centroidWhole="0"/>
              <rendering obstacleFactor="1" mergeLines="0" obstacleType="0" fontMaxPixelSize="10000" drawLabels="1" scaleMax="5000" scaleVisibility="1" upsidedownLabels="0" fontLimitPixelSize="0" obstacle="1" minFeatureSize="0" limitNumLabels="0" scaleMin="1" fontMinPixelSize="3" unplacedVisibility="0" labelPerPart="0" zIndex="0" maxNumLabels="2000"/>
              <dd_properties>
                <Option type="Map">
                  <Option value="" name="name" type="QString"/>
                  <Option name="properties"/>
          ...
          <rule description="Beschriftung Kreisquerschnitt 1:2500" scalemindenom="1000" key="{374e8165-a695-451f-bcea-62860a8230d6}" scalemaxdenom="2500">
            <settings calloutType="simple">
              <text-style fontLetterSpacing="0" fontItalic="0" capitalization="0" useSubstitutions="0" fontSize="10" fontWordSpacing="0" blendMode="0" allowHtml="0" forcedItalic="0" legendString="Aa" namedStyle="Regular" multilineHeightUnit="Percentage" fontSizeUnit="Point" textOpacity="1" fontUnderline="0" textOrientation="horizontal" fontWeight="50" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="MS Shell Dlg 2" forcedBold="0" fontStrikeout="0" fieldName="haltnam" multilineHeight="1" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="50,50,50,255">
                <families/>
                <text-buffer bufferSizeUnits="MM" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferDraw="1" bufferSize="0.80000000000000004" bufferColor="250,250,250,255" bufferBlendMode="0" bufferJoinStyle="128"/>
                <text-mask maskSizeUnits="MM" maskedSymbolLayers="" maskJoinStyle="128" maskSize="0" maskOpacity="1" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0"/>
                <background shapeSizeUnit="Point" shapeSVGFile="" shapeRotation="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeBorderColor="128,128,128,255" shapeOpacity="1" shapeType="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="Point" shapeOffsetX="0" shapeFillColor="255,255,255,255" shapeSizeY="0" shapeRadiiX="0" shapeRadiiUnit="Point" shapeSizeX="0" shapeOffsetY="0" shapeRadiiY="0" shapeJoinStyle="64" shapeOffsetUnit="Point" shapeDraw="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRotationType="0" shapeBorderWidth="0" shapeBlendMode="0">
                  <symbol alpha="1" is_animated="0" name="markerSymbol" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                    <data_defined_properties>
                      <Option type="Map">
                        <Option value="" name="name" type="QString"/>
              ...
              <text-format reverseDirectionSymbol="0" addDirectionSymbol="0" rightDirectionSymbol=">" multilineAlign="0" formatNumbers="0" decimals="3" plussign="0" wrapChar="" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" autoWrapLength="0"/>
              <placement priority="5" placement="2" offsetUnits="MM" overlapHandling="PreventOverlap" layerType="LineGeometry" centroidInside="0" polygonPlacementFlags="2" preserveRotation="1" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" overrunDistanceUnit="MM" lineAnchorTextPoint="CenterOfText" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" lineAnchorPercent="0.5" repeatDistanceUnits="MM" rotationAngle="0" maxCurvedCharAngleIn="25" geometryGeneratorEnabled="0" overrunDistance="0" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placementFlags="10" quadOffset="4" dist="0" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" rotationUnit="AngleDegrees" lineAnchorClipping="0" allowDegraded="0" fitInPolygonOnly="0" distUnits="MM" lineAnchorType="0" centroidWhole="0"/>
              <rendering obstacleFactor="1" mergeLines="0" obstacleType="1" fontMaxPixelSize="10000" drawLabels="1" scaleMax="0" scaleVisibility="0" upsidedownLabels="0" fontLimitPixelSize="0" obstacle="1" minFeatureSize="0" limitNumLabels="0" scaleMin="0" fontMinPixelSize="3" unplacedVisibility="0" labelPerPart="0" zIndex="0" maxNumLabels="2000"/>
              <dd_properties>
                <Option type="Map">
                  <Option value="" name="name" type="QString"/>
                  <Option name="properties"/>
      ...
      <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
        <DiagramCategory backgroundAlpha="255" spacingUnitScale="3x:0,0,0,0,0,0" width="15" spacingUnit="MM" minimumSize="0" penColor="#000000" sizeScale="3x:0,0,0,0,0,0" spacing="0" penWidth="0" diagramOrientation="Up" penAlpha="255" showAxis="0" height="15" labelPlacementMethod="XHeight" opacity="1" backgroundColor="#ffffff" sizeType="MM" rotationOffset="270" lineSizeType="MM" scaleBasedVisibility="0" lineSizeScale="3x:0,0,0,0,0,0" enabled="0" maxScaleDenominator="1e+08" scaleDependency="Area" direction="1" barWidth="5" minScaleDenominator="100000">
      ...
      <DiagramLayerSettings zIndex="0" placement="2" priority="0" dist="0" obstacle="0" showAll="1" linePlacementFlags="2">
        <properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties" type="Map">
              <Option name="show" type="Map">
                <Option value="true" name="active" type="bool"/>
                <Option value="pk" name="field" type="QString"/>
      ...
      <fieldConfiguration>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="knotentyp_20161204084617148" name="Layer" type="QString"/>
                <Option value="Knotentyp" name="LayerName" type="QString"/>
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;schaechte&quot; (geop)" name="LayerSource" type="QString"/>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="" name="Description" type="QString"/>
                <Option value="" name="FilterExpression" type="QString"/>
                <Option value="name" name="Key" type="QString"/>
                <Option value="eigentum_a1c903df_4af8_4ecf_9da6_8892afa11450" name="Layer" type="QString"/>
                <Option value="Eigentum" name="LayerName" type="QString"/>
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;eigentum&quot;" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="true" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;teilgebiete&quot; (geom)" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="true" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="" name="Description" type="QString"/>
                <Option value="" name="FilterExpression" type="QString"/>
                <Option value="profilnam" name="Key" type="QString"/>
                <Option value="profile20161018090721921" name="Layer" type="QString"/>
                <Option value="Profile" name="LayerName" type="QString"/>
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;profile&quot;" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="false" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
                <Option value="profilnam" name="Value" type="QString"/>
              </Option>
            </config>
          </editWidget>
        </field>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;entwaesserungsarten&quot;" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="false" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
          ...
          <editWidget type="ValueRelation">
            <config>
              <Option type="Map">
                ...
                <Option value="Planungsstatus" name="LayerName" type="QString"/>
                <Option value="spatialite" name="LayerProviderName" type="QString"/>
                <Option value="dbname='demo.sqlite' table=&quot;simulationsstatus&quot;" name="LayerSource" type="QString"/>
                <Option value="1" name="NofColumns" type="int"/>
                <Option value="false" name="OrderByValue" type="bool"/>
                <Option value="true" name="UseCompleter" type="bool"/>
                <Option value="bezeichnung" name="Value" type="QString"/>
          ...
          <editWidget type="CheckBox">
            <config>
              <Option type="Map">
                ...
                <Option value="1" name="TextDisplayMethod" type="int"/>
        ...
        <field name="laenge_3d" configurationFlags="None">
          <editWidget type="TextEdit">
            <config>
              <Option/>
            </config>
      ...
      <aliases>
        ...
        <alias field="haltnam" index="1" name="Bezeichnung"/>
        ...
        <alias field="eigentum" index="11" name="Eigentümer"/>
        <alias field="teilgebiet" index="12" name="Teilgebiet"/>
      ...
      <defaults>
        ...
        <default field="eigentum" applyOnUpdate="0" expression=""/>
        ...
        <default field="rwanschluss" applyOnUpdate="0" expression=""/>
        ...
        <default field="laenge_3d" applyOnUpdate="0" expression=""/>
      </defaults>
      <constraints>
        ...
        <constraint field="eigentum" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        ...
        <constraint field="haltungstyp" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="simstatus" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="rwanschluss" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        <constraint field="druckdicht" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
        ...
        <constraint field="laenge_3d" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
      </constraints>
      <constraintExpressions>
        ...
        <constraint field="eigentum" exp="" desc=""/>
        ...
        <constraint field="haltungstyp" exp="" desc=""/>
        <constraint field="simstatus" exp="" desc=""/>
        <constraint field="rwanschluss" exp="" desc=""/>
        ...
        <constraint field="laenge_3d" exp="" desc=""/>
      </constraintExpressions>
      <expressionfields>
        <field precision="0" name="laenge_3d" comment="" subType="0" expression="round(sqrt(length($geometry)^2 + (sohleoben-sohleunten)^2), 3)" typeName="double precision" type="6" length="-1"/>
      </expressionfields>
      <attributeactions>
      ...
      <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
        <columns>
          ...
          <column name="haltungstyp" hidden="0" width="-1" type="field"/>
          <column name="simstatus" hidden="0" width="-1" type="field"/>
          <column name="rwanschluss" hidden="0" width="-1" type="field"/>
          <column name="druckdicht" hidden="0" width="-1" type="field"/>
          ...
          <column name="laenge_3d" hidden="0" width="-1" type="field"/>
      ...
      <labelOnTop>
        ...
        <field name="laenge_3d" labelOnTop="0"/>
        <field name="material" labelOnTop="0"/>
        <field name="netztyp" labelOnTop="0"/>
        ...
        <field name="rwanschluss" labelOnTop="0"/>
