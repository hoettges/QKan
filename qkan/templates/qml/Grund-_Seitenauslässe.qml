...
<flags>
            ...
            <layer locked="0" enabled="1" class="MarkerLine" pass="0">
              ...
              <symbol alpha="1" is_animated="0" name="@0@1" clip_to_extent="1" force_rhr="0" type="marker" frame_rate="10">
                ...
                <layer locked="0" enabled="1" class="FontMarker" pass="0">
                  <Option type="Map">
                    <Option value="0" name="angle" type="QString"/>
                    <Option value="G" name="chr" type="QString"/>
      ...
      <aliases>
        ...
        <alias field="breite" index="5" name="Öffnungsbreite"/>
        ...
        <alias field="entwart" index="15" name="Entwässerungsart"/>
      ...
      <defaults>
        ...
        <default field="haltungstyp" applyOnUpdate="1" expression="'GrundSeitenauslass'"/>
      ...
      <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
        <columns>
          ...
          <column name="hoehe" hidden="0" width="145" type="field"/>
          ...
          <column name="entwart" hidden="0" width="129" type="field"/>
