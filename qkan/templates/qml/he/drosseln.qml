...
<qgis hasScaleBasedVisibilityFlag="1" simplifyDrawingTol="1" simplifyAlgorithm="0" labelsEnabled="0" version="3.22.4-Białowieża" minScale="15000" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="1" readOnly="0" simplifyMaxScale="1" simplifyLocal="1" styleCategories="AllStyleCategories">
  <flags>
  ...
  <aliases>
    ...
    <alias field="hoehe" name="Max. Öffnungshöhe" index="4"/>
    <alias field="breite" name="Breite" index="5"/>
    ...
    <alias field="ks" name="Verlustbeiwert" index="16"/>
    <alias field="haltungstyp" name="Haltungstyp" index="17"/>
    ...
    <alias field="xschob" name="x_anf" index="21"/>
    <alias field="yschob" name="y_anf" index="22"/>
    <alias field="xschun" name="x_end" index="23"/>
    <alias field="yschun" name="y_end" index="24"/>
  </aliases>
  <defaults>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="hoehe" type="field" hidden="1" width="-1"/>
      <column name="breite" type="field" hidden="1" width="-1"/>
      ...
      <column name="entwart" type="field" hidden="0" width="223"/>
      <column name="material" type="field" hidden="1" width="-1"/>
      <column name="ks" type="field" hidden="1" width="-1"/>
  ...
  <storedexpressions/>
  <editform tolerant="1">C:\Users\hoettges\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\qkan\forms\qkan_drossel.ui</editform>
  <editforminit/>
