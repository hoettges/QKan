...
<qgis version="3.22.16-Białowieża" styleCategories="Fields|Forms|AttributeTable">
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option name="LayerSource" value="dbname='muster.sqlite' table=&quot;bodenklassen&quot;" type="QString"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column name="pk" width="-1" type="field" hidden="1"/>
      <column name="apnam" width="127" type="field" hidden="0"/>
      <column name="anfangsabflussbeiwert" width="-1" type="field" hidden="0"/>
      <column name="endabflussbeiwert" width="-1" type="field" hidden="0"/>
      <column name="benetzungsverlust" width="-1" type="field" hidden="0"/>
      <column name="muldenverlust" width="-1" type="field" hidden="0"/>
      <column name="benetzung_startwert" width="-1" type="field" hidden="0"/>
      <column name="mulden_startwert" width="-1" type="field" hidden="0"/>
