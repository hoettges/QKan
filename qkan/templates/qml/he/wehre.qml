...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyAlgorithm="0" labelsEnabled="0" version="3.22.4-Białowieża" minScale="0" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingHints="1" readOnly="0" simplifyMaxScale="1" simplifyLocal="1" styleCategories="AllStyleCategories">
      ...
      <symbol alpha="1" name="0" clip_to_extent="1" type="line" force_rhr="0">
        ...
        <layer pass="0" class="SimpleLine" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="242,236,236,255" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="242,236,236,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
        ...
        <layer pass="0" class="MarkerLine" locked="0" enabled="1">
          ...
          <symbol alpha="1" name="@0@4" clip_to_extent="1" type="marker" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="spatialite" name="LayerProviderName" type="QString"/>
            <Option value="dbname='C:/FHAC/hoettges/Kanalprogramme/k_qkan/k_he8qk/beispiele/itwh_845/muster.sqlite' table=&quot;teilgebiete&quot; (geom)" name="LayerSource" type="QString"/>
            <Option value="1" name="NofColumns" type="int"/>
            <Option value="false" name="OrderByValue" type="bool"/>
            <Option value="true" name="UseCompleter" type="bool"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option value="spatialite" name="LayerProviderName" type="QString"/>
            <Option value="dbname='C:/FHAC/hoettges/Kanalprogramme/k_qkan/k_he8qk/beispiele/itwh_845/muster.sqlite' table=&quot;simulationsstatus&quot;" name="LayerSource" type="QString"/>
            <Option value="1" name="NofColumns" type="int"/>
            <Option value="false" name="OrderByValue" type="bool"/>
  ...
  <aliases>
    ...
    <alias field="haltnam" name="Name" index="1"/>
    <alias field="schoben" name="Anfangsschacht" index="2"/>
    <alias field="schunten" name="Endschacht" index="3"/>
    <alias field="hoehe" name="Öffnungshöhe" index="4"/>
    <alias field="breite" name="Kantenlänge" index="5"/>
    <alias field="laenge" name="Länge" index="6"/>
    ...
    <alias field="ks" name="Überfallbeiwert" index="16"/>
    <alias field="haltungstyp" name="Sonderelementtyp" index="17"/>
    <alias field="simstatus" name="Planungsstatus" index="18"/>
    <alias field="kommentar" name="Kommentar" index="19"/>
    <alias field="createdat" name="bearbeitet" index="20"/>
    <alias field="xschob" name="" index="21"/>
    <alias field="yschob" name="" index="22"/>
    <alias field="xschun" name="" index="23"/>
    <alias field="yschun" name="" index="24"/>
  </aliases>
  <defaults>
    ...
    <default field="haltungstyp" applyOnUpdate="0" expression="'Wehr'"/>
  ...
  <constraints>
    ...
    <constraint field="haltungstyp" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="laenge" type="field" hidden="1" width="-1"/>
      ...
      <column name="sohleoben" type="field" hidden="1" width="-1"/>
      <column name="sohleunten" type="field" hidden="1" width="-1"/>
      <column name="deckeloben" type="field" hidden="1" width="-1"/>
      <column name="deckelunten" type="field" hidden="1" width="-1"/>
      <column name="qzu" type="field" hidden="1" width="-1"/>
      <column name="profilnam" type="field" hidden="1" width="-1"/>
      <column name="teilgebiet" type="field" hidden="0" width="-1"/>
      <column name="entwart" type="field" hidden="0" width="-1"/>
      <column name="material" type="field" hidden="1" width="-1"/>
      ...
      <column name="xschob" type="field" hidden="1" width="-1"/>
      <column name="yschob" type="field" hidden="1" width="-1"/>
      <column name="xschun" type="field" hidden="1" width="-1"/>
      <column name="yschun" type="field" hidden="1" width="-1"/>
