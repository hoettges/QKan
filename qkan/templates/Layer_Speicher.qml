...
<qgis readOnly="0" maxScale="0" minScale="100000000" simplifyDrawingHints="0" version="3.18.3-Zürich" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering" hasScaleBasedVisibilityFlag="0" labelsEnabled="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Bold" fontWeight="75" fontKerning="1" textColor="113,114,113,255" blendMode="0" fontUnderline="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" allowHtml="0" fontFamily="MS Shell Dlg 2" useSubstitutions="0" fieldName="schnam" textOpacity="1" fontWordSpacing="0" fontItalic="0" fontSize="10" multilineHeight="1" isExpression="0" fontLetterSpacing="0" capitalization="0" fontSizeUnit="Point" fontStrikeout="0">
      ...
      <placement distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGeneratorType="PointGeometry" placement="6" placementFlags="10" offsetType="0" polygonPlacementFlags="2" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" dist="3" centroidInside="0" geometryGenerator="" xOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MapUnit" maxCurvedCharAngleOut="-25" rotationAngle="0" layerType="PointGeometry" distUnits="MM" centroidWhole="0" priority="6" overrunDistance="0" lineAnchorType="0" geometryGeneratorEnabled="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" lineAnchorPercent="0" yOffset="0" repeatDistanceUnits="MM" quadOffset="4" repeatDistance="0"/>
      <rendering obstacleType="0" zIndex="0" obstacleFactor="1" displayAll="0" upsidedownLabels="0" limitNumLabels="0" mergeLines="0" scaleVisibility="0" labelPerPart="0" fontMaxPixelSize="10000" obstacle="1" fontMinPixelSize="3" maxNumLabels="2000" drawLabels="1" minFeatureSize="0" scaleMin="1" scaleMax="10000000" fontLimitPixelSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <defaults>
    ...
    <default field="schachttyp" applyOnUpdate="0" expression="'Speicher'"/>
