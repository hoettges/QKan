...
<qgis readOnly="0" maxScale="1" minScale="15000" simplifyDrawingHints="0" version="3.18.3-Zürich" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering" hasScaleBasedVisibilityFlag="1" labelsEnabled="1">
  <flags>
  ...
  <renderer-v2 type="categorizedSymbol" symbollevels="0" forceraster="0" enableorderby="0" attr="entwart">
    <categories>
      <category symbol="0" value="Mischwasser" label="Mischwasser" render="true"/>
      <category symbol="1" value="Regenwasser" label="Regenwasser" render="true"/>
      <category symbol="2" value="Schmutzwasser" label="Schmutzwasser" render="true"/>
      <category symbol="3" value="" label="" render="true"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" type="line" name="0" alpha="1" force_rhr="0">
        ...
        <layer class="SimpleLine" pass="0" locked="0" enabled="1">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="round" k="joinstyle"/>
          <prop v="212,47,241,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="1.76" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
      ...
      <symbol clip_to_extent="1" type="line" name="1" alpha="1" force_rhr="0">
        ...
        <layer class="SimpleLine" pass="0" locked="0" enabled="1">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="round" k="joinstyle"/>
          <prop v="0,63,255,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="1.76" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
        ...
        <layer class="MarkerLine" pass="0" locked="0" enabled="1">
          ...
          <symbol clip_to_extent="1" type="marker" name="@1@2" alpha="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" name="name" value=""/>
                <Option name="properties"/>
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="outlineWidth">
                  <Option type="bool" name="active" value="true"/>
                  <Option type="QString" name="expression" value="0.8 + &#xa;if(breite = 0,hoehe,&#xa;if(hoehe=0,breite, sqrt(hoehe*breite)))"/>
                  <Option type="int" name="type" value="3"/>
                </Option>
              </Option>
              <Option type="QString" name="type" value="collection"/>
      ...
      <symbol clip_to_extent="1" type="line" name="0" alpha="1" force_rhr="0">
        ...
        <layer class="SimpleLine" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="draw_inside_polygon" value="0"/>
            <Option type="QString" name="joinstyle" value="round"/>
            <Option type="QString" name="line_color" value="255,248,195,255"/>
            <Option type="QString" name="line_style" value="solid"/>
            <Option type="QString" name="line_width" value="1.76"/>
            <Option type="QString" name="line_width_unit" value="MM"/>
            <Option type="QString" name="offset" value="0"/>
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="round" k="joinstyle"/>
          <prop v="255,248,195,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="1.76" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Standard" fontWeight="50" fontKerning="1" textColor="108,79,165,255" blendMode="0" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" allowHtml="0" fontFamily="MS Shell Dlg 2" useSubstitutions="0" fieldName="haltnam" textOpacity="1" fontWordSpacing="0" fontItalic="0" fontSize="9" multilineHeight="1" isExpression="0" fontLetterSpacing="0" capitalization="0" fontSizeUnit="Point" fontStrikeout="0">
      ...
      <placement distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGeneratorType="PointGeometry" placement="2" placementFlags="10" offsetType="0" polygonPlacementFlags="2" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="20" dist="2" centroidInside="0" geometryGenerator="" xOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MapUnit" maxCurvedCharAngleOut="-20" rotationAngle="0" layerType="LineGeometry" distUnits="MM" centroidWhole="0" priority="5" overrunDistance="0" lineAnchorType="0" geometryGeneratorEnabled="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" lineAnchorPercent="0" yOffset="0" repeatDistanceUnits="MM" quadOffset="4" repeatDistance="0"/>
      <rendering obstacleType="0" zIndex="0" obstacleFactor="1" displayAll="0" upsidedownLabels="0" limitNumLabels="0" mergeLines="0" scaleVisibility="1" labelPerPart="0" fontMaxPixelSize="10000" obstacle="1" fontMinPixelSize="3" maxNumLabels="2000" drawLabels="1" minFeatureSize="0" scaleMin="1" scaleMax="5000" fontLimitPixelSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="1" field="haltnam" name=""/>
    <alias index="2" field="schoben" name=""/>
    <alias index="3" field="schunten" name=""/>
    <alias index="4" field="hoehe" name=""/>
    <alias index="5" field="breite" name=""/>
    <alias index="6" field="laenge" name=""/>
    <alias index="7" field="sohleoben" name=""/>
    <alias index="8" field="sohleunten" name=""/>
    <alias index="9" field="deckeloben" name=""/>
    <alias index="10" field="deckelunten" name=""/>
    <alias index="11" field="teilgebiet" name=""/>
    <alias index="12" field="qzu" name=""/>
    <alias index="13" field="profilnam" name=""/>
    <alias index="14" field="entwart" name=""/>
    <alias index="15" field="rohrtyp" name=""/>
    <alias index="16" field="ks" name=""/>
    <alias index="17" field="simstatus" name=""/>
    <alias index="18" field="kommentar" name=""/>
    <alias index="19" field="createdat" name=""/>
    <alias index="20" field="xschob" name=""/>
    <alias index="21" field="yschob" name=""/>
    <alias index="22" field="xschun" name=""/>
    <alias index="23" field="yschun" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="profilnam" applyOnUpdate="0" expression="'Kreisquerschnitt'"/>
    <default field="entwart" applyOnUpdate="0" expression=""/>
    <default field="rohrtyp" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="hoehe" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="breite" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="laenge" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="sohleoben" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="sohleunten" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="deckeloben" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="deckelunten" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="teilgebiet" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="qzu" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="profilnam" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="entwart" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="rohrtyp" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="ks" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    ...
    <constraint field="xschob" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="yschob" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="xschun" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="yschun" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="deckeloben" desc=""/>
    <constraint exp="" field="deckelunten" desc=""/>
    <constraint exp="" field="teilgebiet" desc=""/>
    <constraint exp="" field="qzu" desc=""/>
    <constraint exp="" field="profilnam" desc=""/>
    <constraint exp="" field="entwart" desc=""/>
    <constraint exp="" field="rohrtyp" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;teilgebiet&quot;" sortOrder="1">
    <columns>
      ...
      <column width="-1" type="field" hidden="0" name="deckeloben"/>
      <column width="-1" type="field" hidden="0" name="deckelunten"/>
      <column width="-1" type="field" hidden="0" name="teilgebiet"/>
      <column width="-1" type="field" hidden="0" name="qzu"/>
      <column width="-1" type="field" hidden="0" name="profilnam"/>
      <column width="-1" type="field" hidden="0" name="entwart"/>
      <column width="-1" type="field" hidden="0" name="rohrtyp"/>
