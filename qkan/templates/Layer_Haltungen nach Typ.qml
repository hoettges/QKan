...
<qgis simplifyDrawingHints="0" simplifyLocal="1" version="3.6.3-Noosa" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|Actions|MapTips|AttributeTable|Rendering|CustomProperties|GeometryOptions" hasScaleBasedVisibilityFlag="1" simplifyMaxScale="1" maxScale="1" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingTol="1" readOnly="0" minScale="15000">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" attr="entwart" type="categorizedSymbol">
    <categories>
      <category label="Mischwasser" value="Mischwasser" symbol="0" render="true"/>
      <category label="Regenwasser" value="Regenwasser" symbol="1" render="true"/>
      <category label="Schmutzwasser" value="Schmutzwasser" symbol="2" render="true"/>
    ...
    <symbols>
      <symbol alpha="1" name="0" clip_to_extent="1" force_rhr="0" type="line">
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="offset" type="Map">
                  ...
                  <Option value="0.5 + breite/1.5" name="expression" type="QString"/>
                  <Option value="3" name="type" type="int"/>
                </Option>
                <Option name="outlineWidth" type="Map">
                  <Option value="true" name="active" type="bool"/>
                  <Option value="0.4 + &#xd;&#xa;if(breite = 0,hoehe,&#xd;&#xa;if(hoehe=0,breite, sqrt(hoehe*breite)))" name="expression" type="QString"/>
                  <Option value="3" name="type" type="int"/>
                </Option>
              </Option>
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol alpha="1" name="@0@2" clip_to_extent="1" force_rhr="0" type="marker">
      ...
      <symbol alpha="1" name="1" clip_to_extent="1" force_rhr="0" type="line">
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol alpha="1" name="@1@2" clip_to_extent="1" force_rhr="0" type="marker">
            <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
              <prop v="0" k="angle"/>
      ...
      <symbol alpha="1" name="2" clip_to_extent="1" force_rhr="0" type="line">
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol alpha="1" name="@2@2" clip_to_extent="1" force_rhr="0" type="marker">
            <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
              <prop v="0" k="angle"/>
      ...
      <symbol alpha="1" name="3" clip_to_extent="1" force_rhr="0" type="line">
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol alpha="1" name="@3@2" clip_to_extent="1" force_rhr="0" type="marker">
            <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
              <prop v="0" k="angle"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style fontLetterSpacing="0" textOpacity="1" fontSizeUnit="Point" fontItalic="0" previewBkgrdColor="#ffffff" fontStrikeout="0" fontUnderline="0" isExpression="0" useSubstitutions="0" fontSize="9" fieldName="haltnam" fontWordSpacing="0" fontFamily="MS Shell Dlg 2" blendMode="0" textColor="108,79,165,255" fontWeight="50" multilineHeight="1" fontCapitals="0" namedStyle="Standard" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <placement maxCurvedCharAngleOut="-20" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="20" repeatDistance="0" rotationAngle="0" offsetUnits="MapUnit" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distUnits="MM" dist="2" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" priority="5" placement="2" placementFlags="10" quadOffset="4" fitInPolygonOnly="0" centroidWhole="0" preserveRotation="1" xOffset="0" repeatDistanceUnits="MM" centroidInside="0"/>
      <rendering obstacleFactor="1" zIndex="0" fontMinPixelSize="3" obstacleType="0" labelPerPart="0" mergeLines="0" drawLabels="1" scaleMax="5000" upsidedownLabels="0" fontLimitPixelSize="0" minFeatureSize="0" obstacle="1" displayAll="0" fontMaxPixelSize="10000" maxNumLabels="2000" scaleVisibility="1" limitNumLabels="0" scaleMin="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
  ...
  <defaults>
    ...
    <default expression="" field="rohrtyp" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" exp_strength="0" field="sohleoben" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" exp_strength="0" field="sohleunten" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" exp_strength="0" field="deckeloben" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" exp_strength="0" field="deckelunten" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" exp_strength="0" field="teilgebiet" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" exp_strength="0" field="qzu" constraints="0" unique_strength="0"/>
    ...
    <constraint notnull_strength="0" exp_strength="0" field="rohrtyp" constraints="0" unique_strength="0"/>
    <constraint notnull_strength="0" exp_strength="0" field="ks" constraints="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="deckeloben" desc="" exp=""/>
    <constraint field="deckelunten" desc="" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="1" sortExpression="&quot;teilgebiet&quot;">
    <columns>
      ...
      <column width="-1" name="sohleoben" type="field" hidden="0"/>
      <column width="-1" name="sohleunten" type="field" hidden="0"/>
      <column width="-1" name="deckeloben" type="field" hidden="0"/>
      <column width="-1" name="deckelunten" type="field" hidden="0"/>
      <column width="-1" name="teilgebiet" type="field" hidden="0"/>
      <column width="-1" name="qzu" type="field" hidden="0"/>
      <column width="-1" name="profilnam" type="field" hidden="0"/>
      <column width="-1" name="entwart" type="field" hidden="0"/>
      <column width="-1" name="rohrtyp" type="field" hidden="0"/>
      <column width="-1" name="ks" type="field" hidden="0"/>
  ...
  <editform tolerant="1">C:/FHAC/jupiter/hoettges/team_data/Kanalprogramme/QKan/qkan/forms/qkan_haltungen.ui</editform>
  <editforminit/>
