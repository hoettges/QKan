...
<qgis readOnly="0" maxScale="100000" minScale="100000000" simplifyDrawingHints="0" version="3.18.3-Zürich" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering" hasScaleBasedVisibilityFlag="0" labelsEnabled="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGeneratorType="PointGeometry" placement="1" placementFlags="10" offsetType="0" polygonPlacementFlags="2" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="20" dist="1" centroidInside="0" geometryGenerator="" xOffset="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MapUnit" maxCurvedCharAngleOut="-20" rotationAngle="0" layerType="PolygonGeometry" distUnits="MM" centroidWhole="0" priority="5" overrunDistance="0" lineAnchorType="0" geometryGeneratorEnabled="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" lineAnchorPercent="0" yOffset="-1" repeatDistanceUnits="MM" quadOffset="2" repeatDistance="0"/>
  ...
  <aliases>
    ...
    <alias index="18" field="geop" name=""/>
  ...
  <constraints>
    ...
    <constraint field="geop" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="geop" desc=""/>
    <constraint exp="" field="x" desc=""/>
    <constraint exp="" field="y" desc=""/>
  </constraintExpressions>
  <expressionfields>
    <field type="6" typeName="double precision" name="x" length="-1" expression="x(centroid($geometry))" subType="0" precision="0" comment=""/>
    <field type="6" typeName="double precision" name="y" length="-1" expression="y(centroid($geometry))" subType="0" precision="0" comment=""/>
  </expressionfields>
