...
<qgis readOnly="0" maxScale="0" minScale="1e+08" version="3.18.3-Zürich" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering" hasScaleBasedVisibilityFlag="0">
  ...
  <aliases>
    ...
    <alias index="3" field="mu_nr" name=""/>
    <alias index="4" field="kp_key" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="mu_nr" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="kp_key" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  </constraints>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>COALESCE( format('%1',"he_nr"), '&lt;NULL>' ) + ' - '+&#xd;&#xd;&#xd;&#xd;&#xd;&#xd;&#xd;&#xd;&#xd;&#xd;
 COALESCE( "profilnam", '&lt;NULL>' )</previewExpression>
  <mapTip></mapTip>
