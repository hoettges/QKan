...
<qgis readOnly="0" maxScale="0" minScale="100000000" simplifyDrawingHints="0" version="3.18.3-Zürich" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="LayerConfiguration|Symbology|Labeling|Fields|Forms|MapTips|AttributeTable|Rendering" hasScaleBasedVisibilityFlag="0" labelsEnabled="1">
      ...
      <symbol clip_to_extent="1" type="marker" name="0" alpha="1" force_rhr="0">
        ...
        <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" name="color" value="113,114,113,255"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Standard" fontWeight="50" fontKerning="1" textColor="0,0,0,255" blendMode="0" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" textOrientation="horizontal" allowHtml="0" fontFamily="MS Shell Dlg 2" useSubstitutions="0" fieldName="schnam" textOpacity="1" fontWordSpacing="0" fontItalic="0" fontSize="0" multilineHeight="1" isExpression="0" fontLetterSpacing="0" capitalization="0" fontSizeUnit="Point" fontStrikeout="0">
        <text-buffer bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferSize="1" bufferColor="255,255,255,255" bufferOpacity="1" bufferBlendMode="0" bufferSizeUnits="MM" bufferJoinStyle="128" bufferNoFill="0"/>
      ...
      <text-format wrapChar="" formatNumbers="0" autoWrapLength="0" leftDirectionSymbol="&lt;" plussign="0" useMaxLineLengthForAutoWrap="1" multilineAlign="3" reverseDirectionSymbol="0" placeDirectionSymbol="0" rightDirectionSymbol=">" addDirectionSymbol="0" decimals="3"/>
      <placement distMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGeneratorType="PointGeometry" placement="6" placementFlags="10" offsetType="0" polygonPlacementFlags="2" overrunDistanceUnit="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" dist="2" centroidInside="0" geometryGenerator="" xOffset="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" offsetUnits="MapUnit" maxCurvedCharAngleOut="-25" rotationAngle="0" layerType="PointGeometry" distUnits="MM" centroidWhole="0" priority="5" overrunDistance="0" lineAnchorType="0" geometryGeneratorEnabled="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" lineAnchorPercent="0" yOffset="0" repeatDistanceUnits="MM" quadOffset="4" repeatDistance="0"/>
      <rendering obstacleType="0" zIndex="0" obstacleFactor="1" displayAll="0" upsidedownLabels="0" limitNumLabels="0" mergeLines="0" scaleVisibility="1" labelPerPart="0" fontMaxPixelSize="10000" obstacle="1" fontMinPixelSize="3" maxNumLabels="2000" drawLabels="1" minFeatureSize="0" scaleMin="1" scaleMax="250" fontLimitPixelSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="AllowNull" value="1"/>
            <Option type="QString" name="FilterExpression" value=""/>
            <Option type="QString" name="Key" value="knotentyp"/>
            <Option type="QString" name="Layer" value="knotentypen_52223d4a_7631_4169_b6e4_0fa742c73d3c"/>
            <Option type="QString" name="OrderByValue" value="0"/>
            <Option type="QString" name="UseCompleter" value="1"/>
            <Option type="QString" name="Value" value="knotentyp"/>
          </Option>
        </config>
      </editWidget>
    </field>
      ...
      <editWidget type="ValueRelation">
        <config>
          <Option type="Map">
            ...
            <Option type="QString" name="AllowNull" value="1"/>
            <Option type="QString" name="FilterExpression" value=""/>
            <Option type="QString" name="Key" value="schachttyp"/>
            <Option type="QString" name="Layer" value="schachttypen_4be33fc7_32a2_4f96_b120_4253af1bd597"/>
            <Option type="QString" name="OrderByValue" value="0"/>
            <Option type="QString" name="UseCompleter" value="1"/>
            <Option type="QString" name="Value" value="schachttyp"/>
          </Option>
        </config>
      </editWidget>
    </field>
  ...
  <aliases>
    ...
    <alias index="1" field="schnam" name=""/>
    <alias index="2" field="sohlhoehe" name=""/>
    <alias index="3" field="deckelhoehe" name=""/>
    <alias index="4" field="durchm" name=""/>
    <alias index="5" field="druckdicht" name=""/>
    <alias index="6" field="ueberstauflaeche" name=""/>
    <alias index="7" field="entwart" name=""/>
    <alias index="8" field="strasse" name=""/>
    <alias index="9" field="teilgebiet" name=""/>
    <alias index="10" field="knotentyp" name=""/>
    <alias index="11" field="auslasstyp" name=""/>
    <alias index="12" field="schachttyp" name=""/>
    <alias index="13" field="simstatus" name=""/>
    <alias index="14" field="kommentar" name=""/>
    <alias index="15" field="createdat" name=""/>
    <alias index="16" field="xsch" name=""/>
    <alias index="17" field="ysch" name=""/>
    <alias index="18" field="geom" name=""/>
    <alias index="19" field="x" name=""/>
    <alias index="20" field="y" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="sohlhoehe" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="deckelhoehe" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="durchm" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="druckdicht" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="ueberstauflaeche" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="entwart" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="strasse" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="teilgebiet" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="knotentyp" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="auslasstyp" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="schachttyp" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    ...
    <constraint field="xsch" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="ysch" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="geom" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="x" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="y" constraints="0" exp_strength="0" unique_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" field="pk" desc=""/>
    <constraint exp="" field="schnam" desc=""/>
    <constraint exp="" field="sohlhoehe" desc=""/>
    <constraint exp="" field="deckelhoehe" desc=""/>
    <constraint exp="" field="durchm" desc=""/>
    <constraint exp="" field="druckdicht" desc=""/>
    <constraint exp="" field="ueberstauflaeche" desc=""/>
    <constraint exp="" field="entwart" desc=""/>
    <constraint exp="" field="strasse" desc=""/>
    <constraint exp="" field="teilgebiet" desc=""/>
    <constraint exp="" field="knotentyp" desc=""/>
    <constraint exp="" field="auslasstyp" desc=""/>
    <constraint exp="" field="schachttyp" desc=""/>
    <constraint exp="" field="simstatus" desc=""/>
    <constraint exp="" field="kommentar" desc=""/>
    <constraint exp="" field="createdat" desc=""/>
    <constraint exp="" field="xsch" desc=""/>
    <constraint exp="" field="ysch" desc=""/>
    <constraint exp="" field="geom" desc=""/>
    <constraint exp="" field="x" desc=""/>
    <constraint exp="" field="y" desc=""/>
  </constraintExpressions>
  <expressionfields>
    <field type="6" typeName="double precision" name="x" length="-1" expression="$x" subType="0" precision="0" comment=""/>
    <field type="6" typeName="double precision" name="y" length="-1" expression="$y" subType="0" precision="0" comment=""/>
    <field type="6" typeName="" name="x" length="0" expression="$x" subType="0" precision="0" comment=""/>
    <field type="6" typeName="" name="y" length="0" expression="$y" subType="0" precision="0" comment=""/>
  </expressionfields>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;pk&quot;" sortOrder="0">
    <columns>
      ...
      <column width="122" type="field" hidden="0" name="createdat"/>
      <column width="132" type="field" hidden="0" name="geom"/>
