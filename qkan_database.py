...
def createdbtables(consl,cursl):
    ...
    # try:
        ...
        # cursl.execute(sql2)
    # except:
        # iface.messageBar().pushMessage("Fehler", 'In der Tabelle "Auslaesse" konnten das Attribute "geom" nicht hinzugefuegt werden!\nAbbruch!', level=QgsMessageBar.CRITICAL)
        # return False
    ...
    # try:
        ...
        # cursl.execute(sql2)
    # except:
        # iface.messageBar().pushMessage("Fehler", 'In der Tabelle "Speicherschaechte" konnten die Attribute "geop" und "geom" nicht hinzugefuegt werden!\nAbbruch!', level=QgsMessageBar.CRITICAL)
        # return False
    ...
    try:
        ...
        iface.messageBar().pushMessage("Fehler", 'In der Tabelle "wehre" konnte das Attribut "geom" nicht hinzugefuegt werden!\nAbbruch!', level=QgsMessageBar.CRITICAL)
        return False
    consl.commit()
    ...
    try:
        ...
        iface.messageBar().pushMessage("Fehler", 'Tabellendaten "simulationsstatus" konnten nicht hinzugefuergt werden!\nAbbruch!', level=QgsMessageBar.CRITICAL)
        return False
    consl.commit()
    ...
    try:
        ...
        iface.messageBar().pushMessage("Fehler", 'Tabellendaten "auslasstypen" konnten nicht hinzugefuergt werden!\nAbbruch!', level=QgsMessageBar.CRITICAL)
        return False
    consl.commit()
    ...
    sql = '''
    CREATE TABLE abflussparameter (pk INTEGER NOT NULL, 
    name TEXT , 
    kommentar TEXT , 
