...
# Form implementation generated from reading ui file 'k_he2qk_dialog_base.ui'
#
...
class Ui_ImportFromHEDialogBase(object):
    def setupUi(self, ImportFromHEDialogBase):
        ...
        ImportFromHEDialogBase.resize(539, 319)
        self.button_box = QtGui.QDialogButtonBox(ImportFromHEDialogBase)
        self.button_box.setGeometry(QtCore.QRect(140, 270, 251, 32))
        font = QtGui.QFont()
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 20, 491, 141))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(20, 170, 491, 81))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
